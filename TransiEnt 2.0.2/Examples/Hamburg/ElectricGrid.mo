...
//________________________________________________________________________________//
  ...
  inner TransiEnt.SimCenter simCenter(
    ...
    P_n_ref_1=4e9,
    Td=60) annotation (Placement(transformation(extent={{-290,140},{-270,160}})));
  inner TransiEnt.ModelStatistics modelStatistics annotation (Placement(transformation(extent={{-270,160},{-250,140}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_BM(y=UC.schedule.y[UC.schedule.BM]) annotation (Placement(transformation(extent={{70,28},{90,48}})));
  Modelica.Blocks.Sources.RealExpression P_set_Offshore(y=P_wind_off_is.y1 + e_wind_prediction_off.y) annotation (Placement(transformation(extent={{-108,124},{-88,144}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_PV(y=P_PV_is.y1 + e_pv_prediction.y) annotation (Placement(transformation(extent={{10,122},{30,142}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_CCP(y=aGC.P_sec_set[UC.schedule.CCP]) annotation (Placement(transformation(extent={{-202,-92},{-182,-72}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_GT(y=aGC.P_sec_set[UC.schedule.GT2]) annotation (Placement(transformation(extent={{-44,-88},{-24,-68}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_PS(y=aGC.P_sec_set[UC.schedule.PS]) annotation (Placement(transformation(extent={{108,-96},{128,-76}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_tieline_set(y=-UC.schedule.y[UC.schedule.Import]) annotation (Placement(transformation(extent={{-170,-234},{-190,-214}})));
  Modelica.Blocks.Sources.RealExpression P_residual_is(y=Demand.epp.P + P_RE_curtailement.epp_out.P + PumpedStorage.epp.P + Biomass.epp.P) annotation (Placement(transformation(extent={{-272,-24},{-252,-4}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_load_is(y=Demand.epp.P) "Freqeuency dependent load" annotation (Placement(transformation(extent={{290,-36},{270,-16}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_CHP_East1(y=aGC.P_sec_set[UC.schedule.GUDTS]) annotation (Placement(transformation(extent={{34,-190},{54,-170}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_BC(y=aGC.P_sec_set[UC.schedule.BC]) annotation (Placement(transformation(extent={{124,16},{144,36}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_GT1(y=aGC.P_sec_set[UC.schedule.GT3]) annotation (Placement(transformation(extent={{32,-86},{52,-66}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_set_SB_GT2(y=aGC.P_sec_set[UC.schedule.GT1]) annotation (Placement(transformation(extent={{-120,-88},{-100,-68}})));
  ...
  Modelica.Blocks.Sources.RealExpression P_residual_pred(y=-sum(UC.schedule.y[simCenter.generationPark.isMOD])) "All disponible plants (Conventional apart from Pumped Storage and CHP)" annotation (Placement(transformation(extent={{-266,-2},{-246,18}})));
  ...
  algorithm
    ...
    createPlot(
        id=1,
        position={0,0,805,842},
        y={"modelStatistics.electricPower.P_gen_total","modelStatistics.electricPower.P_demand","modelStatistics.electricPower.P_residual_pos","modelStatistics.electricPower.P_conventional_with_CHP"},
        filename=resultFileName);
    createPlot(
        id=2,
        position={0,0,805,418},
        y={"P_12.epp_IN.f"},
        filename=resultFileName);
    createPlot(
        id=3,
        position={821,439,804,403},
        y={"P_RE_curtailement.P_el_out","P_RE_curtailement.P_el_in","P_RE_Pred.y"},
        range={0.0,90000.0,400000000.0,1400000000.0},
    ...
    createPlot(
        id=4,
        position={821,0,804,405},
        y={"WW1.P_set_star","WW1.P_set_star_sched","WW1.P_star"},
        range={0.0,90000.0,0.5,1.05},
  ...
  TransiEnt.Grid.Electrical.EconomicDispatch.MeritOrderDispatcher mod(
    ...
    P_max_var={WT.pQDiagram[1].P_max,WW1.pQDiagram[1].P_max},
    P_min_var={WT.pQDiagram[1].P_min,WW1.pQDiagram[1].P_min}) annotation (Placement(transformation(extent={{-170,-28},{-146,-2}})));
...
equation
  ...
  connect(P_set_Curt.y, P_RE_curtailement.u) annotation (Line(points={{155,132},{160,132},{167,132},{167,123.58}}, color={0,0,127}));
  ...
  connect(P_12.epp_IN, PumpedStorage.epp) annotation (Line(
      ...
      color={0,135,135},
      thickness=0.5));
  connect(P_set_SB_PS.y, PumpedStorage.P_SB_set) annotation (Line(points={{129,-86},{132,-86},{137.2,-86},{137.2,-91.09}}, color={0,0,127}));
  connect(P_set_PS.y, PumpedStorage.P_el_set) annotation (Line(points={{151,-72},{151,-72},{152,-72},{152,-89.19}}, color={0,0,127}));
  connect(P_tieline_set.y, aGC.P_tie_set) annotation (Line(points={{-191,-224},{-191,-224},{-195.02,-224},{-195.02,-215}}, color={0,0,127}));
  connect(P_tieline_is.y, aGC.P_tie_is) annotation (Line(points={{-219,-224},{-219,-224},{-210.6,-224},{-210.6,-215}}, color={0,0,127}));
  ...
  connect(discretizePrediction.P_predictions, mod.u) annotation (Line(points={{-185,-14},{-172.4,-14},{-172.4,-15}}, color={0,0,127}));
  connect(H_lpa.y, discretizePrediction.P_is) annotation (Line(points={{-221,-14},{-215.5,-14},{-208,-14}}, color={0,0,127}));
  ...
  annotation (
    ...
    Icon(graphics, coordinateSystem(extent={{-300,-240},{300,160}})),
...
<p><span style=\"font-family: MS Shell Dlg 2;\">The methodology is described in [1].</span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">[1] L. Andresen, P. Dubucq, R. Peniche Garcia, G. Ackermann, A. Kather, and G. Schmitz, &ldquo;Transientes Verhalten gekoppelter Energienetze mit hohem Anteil Erneuerbarer Energien: Abschlussbericht des Verbundvorhabens,&rdquo; Hamburg, 2017.</span></p>
