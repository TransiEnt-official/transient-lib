...
//________________________________________________________________________________//
  ...
  Components.VDI3508Plant BrownCoalPlant(
    P_el_n=1e9,
    eta_total=0.5,
    ...
    nSubgrid=1,
    P_el_star_init=0,
    steamGeneratorControl=TransiEnt.Basics.Types.ClaRaPlantControlStrategy.NSP) annotation (Placement(transformation(extent={{-78,-88},{-10,-32}})));
equation
