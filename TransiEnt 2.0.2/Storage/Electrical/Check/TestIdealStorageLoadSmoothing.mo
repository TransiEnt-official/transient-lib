...
model TestIdealStorageLoadSmoothing "Example to evaluate self discharge time"
...
//________________________________________________________________________________//
  ...
  LoadSmoothingElectricStorage Storage(redeclare TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.PumpStorage CostModel, StorageModelParams=TransiEnt.Storage.Electrical.Specifications.PumpedStorage(
        E_max=1e14,
        P_max_unload=900e6,
        P_max_load=90e6,
        eta_unload=1,
...
equation
  connect(P_residual.y, Storage.P_load) annotation (Line(points={{-19,-12},{36,-12},{36,-18.34}}, color={0,0,127}));
...
end TestIdealStorageLoadSmoothing;
