...
//________________________________________________________________________________//
  ...
  PumpedStorage Storage(redeclare model CostModel=TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.PumpStorage, StorageModelParams=TransiEnt.Storage.Electrical.Specifications.PumpedStorage(
        E_max=1e14,
        P_max_unload=900e6,
        P_max_load=90e6,
        eta_unload=1,
...
function plotResult
  ...
  constant String resultFileName = "TestPumpedStorage.mat";
...
createPlot(id=1, position={809, 0, 791, 269}, y={"Storage.storageModel.SOC"}, range={0.0, 4000000.0, -0.2, 1.0000000000000002}, grid=true, subPlot=2, colors={{28,108,200}}, filename=resultFile);
