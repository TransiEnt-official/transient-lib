...
//________________________________________________________________________________//
 ...
 // parameter Modelica.SIunits.Area A_heat = 1 "Area of Heat Transfer";
  parameter Modelica.Units.SI.Length height=1 "Height of cylinder (without insulation)";
  parameter Modelica.Units.SI.Length radius=0.1 "Radius of cylinder (without insulation)";
  parameter Modelica.Units.SI.Length width=0.1 "Thickness of insulation";
