...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer U=0.5 "Coefficient of heat transfer to ambient (side, top and bottom walls)" annotation (Dialog(group="Thermodynamics"));
