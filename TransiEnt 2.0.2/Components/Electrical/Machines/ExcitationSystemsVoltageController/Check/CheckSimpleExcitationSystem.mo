...
model CheckSimpleExcitationSystem "Test for SimpleExcitationSystem"
...
// _____________________________________________
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary4(tau_is(start=63662))
        ...
        rotation=0,
        origin={-157,-99})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplexSubtransient twoAxisSynchronousMachineComplexSubtransient4(v_n=380e3) annotation (Placement(transformation(extent={{-106,-108},{-86,-88}})));
  ...
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.SimpleExcitationSystem                  simpleExcitationSystem                   annotation (Placement(transformation(extent={{-48,108},{-28,128}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.SimpleExcitationSystem simpleExcitationSystem1(v_n=380e3) annotation (Placement(transformation(extent={{-94,82},{-114,102}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.SimpleExcitationSystem simpleExcitationSystem2(v_n=380e3) annotation (Placement(transformation(extent={{-96,0},{-116,20}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.SimpleExcitationSystem simpleExcitationSystem3(v_n=380e3) annotation (Placement(transformation(extent={{-88,-78},{-108,-58}})));
...
// _____________________________________________
  ...
  connect(transformerComplex4.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(simpleExcitationSystem.y, twoAxisSynchronousMachineComplexSubtransient1.E_input) annotation (Line(points={{-27.4,118},{-1.7,118},{-1.7,109.9}}, color={0,0,127}));
  connect(simpleExcitationSystem.epp1, load.epp) annotation (Line(
      points={{-48,118},{-56,118},{-56,100},{-28,100},{-28,64},{-28,64},{-28,44},{-5.8,44}},
      color={28,108,200},
      thickness=0.5));
  connect(twoAxisSynchronousMachineComplexSubtransient2.E_input, simpleExcitationSystem1.y) annotation (Line(points={{-100.3,71.9},{-126,71.9},{-126,92},{-114.6,92}}, color={0,0,127}));
  connect(simpleExcitationSystem1.epp1, twoAxisSynchronousMachineComplexSubtransient2.epp) annotation (Line(
      points={{-94,92},{-90,92},{-90,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(simpleExcitationSystem2.epp1, transmissionLine3.epp_p) annotation (Line(
      points={{-96,10},{-90,10},{-90,-18},{-86,-18}},
      color={28,108,200},
      thickness=0.5));
  connect(simpleExcitationSystem2.y, twoAxisSynchronousMachineComplexSubtransient3.E_input) annotation (Line(points={{-116.6,10},{-130,10},{-130,-8.1},{-102.3,-8.1}}, color={0,0,127}));
  connect(simpleExcitationSystem3.y, twoAxisSynchronousMachineComplexSubtransient4.E_input) annotation (Line(points={{-108.6,-68},{-118,-68},{-118,-88.1},{-96.3,-88.1}}, color={0,0,127}));
  connect(simpleExcitationSystem3.epp1, twoAxisSynchronousMachineComplexSubtransient4.epp) annotation (Line(
...
<p>Test environment for the SimpleExcitationSystem model</p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Model created by Jan-Peter Heckel (jan.heckel@tuhh.de) in Augst 2018</span></p>
</html>"),
...
end CheckSimpleExcitationSystem;
