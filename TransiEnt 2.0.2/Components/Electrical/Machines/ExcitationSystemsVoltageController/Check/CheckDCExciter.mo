...
model CheckDCExciter "Test for DCExciter"
...
// _____________________________________________
  ...
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DCExciter                               dCExciter                                annotation (Placement(transformation(extent={{-48,108},{-28,128}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DCExciter dCExciter1(v_n=380e3) annotation (Placement(transformation(extent={{-94,82},{-114,102}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DCExciter dCExciter2(v_n=380e3) annotation (Placement(transformation(extent={{-96,0},{-116,20}})));
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DCExciter dCExciter3(v_n=380e3) annotation (Placement(transformation(extent={{-88,-78},{-108,-58}})));
...
// _____________________________________________
  ...
  connect(transformerComplex4.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(dCExciter.y, twoAxisSynchronousMachineComplexSubtransient1.E_input) annotation (Line(points={{-27.4,118},{-1.7,118},{-1.7,109.9}}, color={0,0,127}));
  connect(dCExciter.epp1, load.epp) annotation (Line(
      points={{-48,118},{-56,118},{-56,100},{-28,100},{-28,64},{-28,64},{-28,44},{-5.8,44}},
      color={28,108,200},
      thickness=0.5));
  connect(twoAxisSynchronousMachineComplexSubtransient2.E_input, dCExciter1.y) annotation (Line(points={{-100.3,71.9},{-126,71.9},{-126,92},{-114.6,92}}, color={0,0,127}));
  connect(dCExciter1.epp1, twoAxisSynchronousMachineComplexSubtransient2.epp) annotation (Line(
      points={{-94,92},{-90,92},{-90,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(dCExciter2.epp1, transmissionLine3.epp_p) annotation (Line(
      points={{-96,10},{-90,10},{-90,-18},{-86,-18}},
      color={28,108,200},
      thickness=0.5));
  connect(dCExciter2.y, twoAxisSynchronousMachineComplexSubtransient3.E_input) annotation (Line(points={{-116.6,10},{-130,10},{-130,-8.1},{-102.3,-8.1}}, color={0,0,127}));
  connect(dCExciter3.y, twoAxisSynchronousMachineComplexSubtransient4.E_input) annotation (Line(points={{-108.6,-68},{-118,-68},{-118,-88.1},{-96.3,-88.1}}, color={0,0,127}));
  connect(dCExciter3.epp1, twoAxisSynchronousMachineComplexSubtransient4.epp) annotation (Line(
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Test environment for the DCExciter model</span></p>
