...
//   parameter SI.Resistance R_S( min= 0) = R_P "Secundary resistance" annotation(Dialog(group="lose properties"));
  parameter Modelica.Units.SI.Reactance X_h=80e3 "Main Reactance, applied on primary side" annotation (Dialog(group="lose properties"));
  parameter Modelica.Units.SI.Resistance R_Cu=2 "Copper Resistance, applied on primary side" annotation (Dialog(group="lose properties"));
  parameter Modelica.Units.SI.Reactance X_sigma=35 "Stray Reactance, applied on primary side" annotation (Dialog(group="lose properties"));
  parameter Modelica.Units.SI.Resistance R_Fe=400e3 "Iron Resistance, applied on primary side" annotation (Dialog(group="lose properties"));
