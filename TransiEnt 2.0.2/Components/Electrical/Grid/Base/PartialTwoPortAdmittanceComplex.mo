...
equation
  ...
  S_p.re     = epp_p.P;
  S_p.im     = epp_p.Q;
  v_p.re     = homotopy(actual = epp_p.v*cos(epp_p.delta),
                    simplified = epp_p.v);
  v_p.im     = homotopy(actual = epp_p.v*sin(epp_p.delta),
                  simplified = epp_p.v*(epp_p.delta));

  S_n.re     = epp_n.P;
  S_n.im     = epp_n.Q;

  v_n.re     = homotopy(actual = epp_n.v*cos(epp_n.delta),
                  simplified = epp_n.v);
  v_n.im     = homotopy(actual = epp_n.v*sin(epp_n.delta),
                  simplified = epp_n.v*(epp_n.delta));
