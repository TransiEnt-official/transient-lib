...
equation
  ...
  connect(y[1], value) annotation (Line(points={{110,0},{88,0},{88,0}},  color={0,0,127}));
...
<p>Direct Horizontal Irradiation in Cologne in a test reference year (TRY) with 60 minutes time resolution.</p>
