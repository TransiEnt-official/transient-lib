...
<p>Global Horizontal Irradiation in Miesbach in a test reference year (TRY) with 60 minutes time resolution. Radiation on tilted surface, Tilt=35, Azimuth=0.</p>
...
end GHI_Miesbach_3600s_TRY_tilt35;
