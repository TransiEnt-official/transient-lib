...
model GHI_Cologne_3600s_TRY_tilt35
  "GHI Cologne TRY, 1 h resolution, tilt = 35"
...
//________________________________________________________________________________//
  ...
  relativepath="ambient/Radiation_PVModule_TRY-Cologne_Az=0_Tilt=35.txt",
...
<p>Global Horizontal Irradiation in Cologne in a test reference year (TRY) with 60 minutes time resolution. Radiation on tilted surface, Tilt=35, Azimuth=0.</p>
...
end GHI_Cologne_3600s_TRY_tilt35;
