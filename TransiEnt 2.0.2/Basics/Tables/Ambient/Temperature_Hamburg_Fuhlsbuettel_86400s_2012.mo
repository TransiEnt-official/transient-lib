...
<p>Ambient temperature in Hamburg in the year 2012 with 24 hours time resolution.</p>
<p>Data from Hamburg Fuhlsbuettel (Lattitude: 53.633 ; Longitude: 9.988 ; station height: 11m)</p>
<p>This profile was created by creating 24 hour averages from the 60 minute values provided by [1]. Missing values were substituted by interpolated values between the values at the extremes of the missing intervals.</p>
...
<p>Model created by Ricardo Peniche (peniche@tuhh.de), Jul 2016</p>
</html>"));
end Temperature_Hamburg_Fuhlsbuettel_86400s_2012;
