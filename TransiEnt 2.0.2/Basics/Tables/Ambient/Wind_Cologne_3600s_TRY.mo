...
equation
  ...
  connect(y[1], value);
  connect(value, y1) annotation (Line(points={{88,0},{110,0}}, color={0,0,127}));
...
<p>Wind Speed in Cologne for a test reference year with 60 minutes time resolution.</p>
