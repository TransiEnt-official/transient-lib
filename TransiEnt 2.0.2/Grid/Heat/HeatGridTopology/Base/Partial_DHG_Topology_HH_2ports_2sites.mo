...
equation
  ...
  annotation (Diagram(graphics,
                      coordinateSystem(preserveAspectRatio=false, extent={{-440,-320},{500,420}})),
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Base model for district heating grid with 2 heat production sides</span></p>
