...
//________________________________________________________________________________//
  ...
  Components.Sensors.RealGas.GCVSensor                vleGCVSensor(medium=medium,flowDefinition=flowDefinition)
...
equation
  ...
  connect(vleCompositionSensor.gasPortIn, fluidPortIn) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(vleGCVSensor.GCV_InToOut, gCVController.GCV_is_sink) annotation (Line(points={{-3,14},{0,14},{0,40},{76,40},{76,4.6}}, color={0,0,127}));
  connect(vleGCVSensor.GCV_OutToIn, gCVController.GCV_is_source) annotation (Line(points={{-3,6},{2,6},{2,36},{72,36},{72,4.6}}, color={0,0,127}));
