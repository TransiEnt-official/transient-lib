...
model TestBoiler_HoldTemperature_L2
...
<p>Test environment for a boiler with a hold temperature and level of detail L2 (defined in the CodingConventions)</p>
...
end TestBoiler_HoldTemperature_L2;
