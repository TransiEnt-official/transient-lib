...
//________________________________________________________________________________//
  ...
  Modelica.Units.SI.ActivePower P=epp.P;
  Modelica.Units.SI.ActivePower P_el_is=-epp.P "Actual active power output";
  Modelica.Units.SI.Frequency f_grid(start=simCenter.f_n) = epp.f;
  Modelica.Units.SI.AngularVelocity omega=der(mpp.phi);
