...
model CheckTwoAxisSynchronousMachineComplexTransient "Test for TwoAxisSynchronousMachineComplex"
...
// _____________________________________________
  ...
  final parameter Modelica.Units.SI.ActivePower P_slack_start(fixed=false);
...
// _____________________________________________
  ...
  Modelica.Blocks.Continuous.FirstOrder actuator2(
    k=1,
    T=0.3,
    initType=Modelica.Blocks.Types.Init.InitialState) annotation (Placement(transformation(extent={{-68,106},{-88,126}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary2(tau_is(start=63662))
        ...
        rotation=0,
        origin={-155,63})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplexTransient twoAxisSynchronousMachineComplexTransient2(v_n=380e3) annotation (Placement(transformation(extent={{-110,52},{-90,72}})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplexTransient       twoAxisSynchronousMachineComplexTransient1(IsSlack=true)
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary3(tau_is(start=63662))
        ...
        rotation=0,
        origin={-159,-17})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplexTransient twoAxisSynchronousMachineComplexTransient3(v_n=380e3) annotation (Placement(transformation(extent={{-112,-28},{-92,-8}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary4(tau_is(start=63662))
        ...
        rotation=0,
        origin={-157,-99})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplexTransient twoAxisSynchronousMachineComplexTransient4(v_n=380e3, R_a=0) annotation (Placement(transformation(extent={{-106,-108},{-86,-88}})));
  ...
  TransiEnt.Components.Sensors.ElectricFrequencyComplex globalFrequency annotation (Placement(transformation(extent={{-150,126},{-130,146}})));
// _____________________________________________
//
//           Functions
// _____________________________________________
...
function plotResult
  ...
  constant String resultFileName = "CheckTwoAxisSynchronousMachineComplexTransient.mat";
...
algorithm
  ...
  removePlots();
createPlot(id=1, position={809, 0, 791, 733}, y={"twoAxisSynchronousMachineComplexTransient1.e_d_trans", "twoAxisSynchronousMachineComplexTransient1.e_q_trans"}, grid=true, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
createPlot(id=1, position={809, 0, 791, 364}, y={"twoAxisSynchronousMachineComplexTransient1.i_d", "twoAxisSynchronousMachineComplexTransient1.i_q"}, grid=true, subPlot=2, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
createPlot(id=2, position={0, 0, 791, 733}, y={"twoAxisSynchronousMachineComplexTransient1.epp.f"}, grid=true, colors={{28,108,200}}, filename=resultFile);
createPlot(id=2, position={0, 0, 791, 364}, y={"twoAxisSynchronousMachineComplexTransient3.epp.P", "twoAxisSynchronousMachineComplexTransient3.epp.Q"},  grid=true, subPlot=2, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
...
initial equation
  ...
  P_slack_start=twoAxisSynchronousMachineComplexTransient1.P_mech;
...
// _____________________________________________
  ...
  connect(actuator2.y, turbine2.u) annotation (Line(points={{-89,116},{-102,116}}, color={0,0,127}));
  connect(actuator2.u, feedback.y) annotation (Line(points={{-66,116},{-62,116},{-62,148},{-115,148}}, color={0,0,127}));
  connect(twoAxisSynchronousMachineComplexTransient1.mpp, constantInertia1.mpp_a) annotation (Line(points={{8,100},{14,100},{14,100},{18,100},{18,102},{22,102}},     color={95,95,95}));
  connect(constantInertia1.mpp_b, mechanicalBoundary1.mpp) annotation (Line(points={{42,102},{48,102},{48,103},{58,103}},                 color={95,95,95}));
  connect(twoAxisSynchronousMachineComplexTransient2.mpp, constantInertia2.mpp_b) annotation (Line(points={{-110,62},{-116,62},{-116,62}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplexTransient3.mpp, constantInertia3.mpp_b) annotation (Line(points={{-112,-18},{-120,-18},{-120,-16}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplexTransient4.mpp, constantInertia4.mpp_b) annotation (Line(points={{-106,-98},{-116,-98},{-116,-98}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplexTransient1.epp, load.epp) annotation (Line(
  ...
  connect(transformerComplex2.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine2.epp_p, twoAxisSynchronousMachineComplexTransient2.epp) annotation (Line(
  ...
  connect(complexPower2.epp, transmissionLine2.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine3.epp_p, twoAxisSynchronousMachineComplexTransient3.epp) annotation (Line(
  ...
  connect(transmissionLine3.epp_n,transformerComplex3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine4.epp_p, twoAxisSynchronousMachineComplexTransient4.epp) annotation (Line(
  ...
  connect(transformerComplex4.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization1.y, twoAxisSynchronousMachineComplexTransient1.E_input) annotation (Line(points={{-27.4,118},{-1.7,118},{-1.7,109.9}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization1.epp1, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(twoAxisSynchronousMachineComplexTransient2.E_input, voltageRegulatorExcitationStabilization2.y) annotation (Line(points={{-100.3,71.9},{-126,71.9},{-126,92},{-114.6,92}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization2.epp1, twoAxisSynchronousMachineComplexTransient2.epp) annotation (Line(
      points={{-94,92},{-90,92},{-90,62},{-89.9,62},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.epp1,transmissionLine3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.y, twoAxisSynchronousMachineComplexTransient3.E_input) annotation (Line(points={{-116.6,10},{-130,10},{-130,-8.1},{-102.3,-8.1}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.y, twoAxisSynchronousMachineComplexTransient4.E_input) annotation (Line(points={{-108.6,-68},{-118,-68},{-118,-88.1},{-96.3,-88.1}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.epp1, twoAxisSynchronousMachineComplexTransient4.epp) annotation (Line(
      points={{-88,-68},{-80,-68},{-80,-98.1},{-85.9,-98.1}},
      color={28,108,200},
      thickness=0.5));
  connect(globalFrequency.epp, twoAxisSynchronousMachineComplexTransient2.epp) annotation (Line(
      points={{-150,136},{-152,136},{-152,126},{-90,126},{-90,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(globalFrequency.f, feedback.u2) annotation (Line(points={{-129.6,136},{-124,136},{-124,140}}, color={0,0,127}));
  connect(slackPowert0.y, add1.u2) annotation (Line(points={{-21,136},{4,136},{4,126},{30,126}}, color={0,0,127}));
...
<p>Test environment for TwoAxisSynchronousMachineTransient</p>
...
end CheckTwoAxisSynchronousMachineComplexTransient;
