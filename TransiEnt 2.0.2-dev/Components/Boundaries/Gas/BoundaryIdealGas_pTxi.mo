...
//________________________________________________________________________________//
  ...
  Modelica.Units.SI.Mass m(start=0, stateSelect=StateSelect.never) annotation (Dialog(group="Initialization", showStartAttribute=true));
...
public
  ...
  TransiEnt.Basics.Interfaces.General.PressureIn p=p_in if (variable_p) "Variable absolute pressure"
