...
public
  ...
  TransiEnt.Basics.Blocks.LimPIDReset H_lfr(
    ...
    yMax=P_SB_max) annotation (Placement(transformation(extent={{6,-10},{26,10}})));
  ...
  Modelica.Blocks.Sources.BooleanConstant alwaysOn(k=true) annotation (Placement(transformation(extent={{48,16},{38,26}})));
...
public
  ...
  parameter Real P_SB_max=57e6 "Upper limit of output";
equation
