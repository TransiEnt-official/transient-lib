...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Tables.ElectricGrid.PowerData.ElectricityDemand_HH_900s_2012 Demand_HH_2012 annotation (Placement(transformation(extent={{-56,-40},{-36,-20}})));
  TransiEnt.Basics.Tables.ElectricGrid.PowerData.ElectricityDemand_HH_900s_2012 IdealPrediction_HH_2012_1h_ahead(startTime=-3600) annotation (Placement(transformation(extent={{-56,-6},{-36,14}})));
