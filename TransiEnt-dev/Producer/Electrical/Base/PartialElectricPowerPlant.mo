...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Power P_el_n=300e6 "Nominal power of plant" annotation (
    Dialog(group="Physical Constraints"),
    HideResult=false,
    Placement(transformation(extent=100)));

  parameter Modelica.Units.SI.Efficiency eta_total=0.6 "Total efficiency of plant for emission calculation" annotation (
