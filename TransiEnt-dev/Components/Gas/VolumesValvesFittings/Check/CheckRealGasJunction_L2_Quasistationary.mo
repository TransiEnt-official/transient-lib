...
//________________________________________________________________________________//
  ...
  extends CheckRealGasJunction_L2(
    realGasJunction_L2_1(massBalance=4),
    realGasJunction_L2_3(massBalance=4),
    realGasJunction_L2_2(massBalance=4),
    realGasJunction_L2_4(massBalance=4));
...
end CheckRealGasJunction_L2_Quasistationary;
