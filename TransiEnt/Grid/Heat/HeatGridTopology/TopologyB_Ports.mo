...
//________________________________________________________________________________//
  ...
  TransiEnt.Consumer.Heat.Consumer consumer_21(
    ...
    Q_flow_nom(displayUnit="kW") = 105000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={100,256})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe42_43(
    d=0.04,
    m_flow_nom=0.84,
    l=60,
    MassFlowState=false,
    N_cv=12) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={96,228})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe42_43R(
    d=0.04,
    m_flow_nom=0.84,
    l=60,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe60_62R(
    ...
    N_cv=12) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={576,218})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe61_63R(
    d=0.04,
    m_flow_nom=0.84,
    l=60,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Fittings.Split split40 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={938,180})));
  TransiEnt.Basics.Interfaces.Thermal.FluidPortIn_simple inlet annotation (Placement(transformation(extent={{-38,368},{-18,388}})));
  TransiEnt.Basics.Interfaces.Thermal.FluidPortOut_simple outlet annotation (Placement(transformation(extent={{10,368},{30,388}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe40_41R(
    d=0.15,
    m_flow_nom=32.63,
    l=60,
    N_cv=12) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={20,342})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe40_41(
    d=0.15,
    m_flow_nom=32.63,
    l=60,
    MassFlowState=false,
