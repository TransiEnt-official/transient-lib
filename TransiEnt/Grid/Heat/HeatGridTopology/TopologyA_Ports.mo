...
//________________________________________________________________________________//
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe15_16R(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    MassFlowState=false) annotation (Placement(transformation(extent={{-14,-125},{6,-106}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe15_16(
    d=0.065,
    m_flow_nom=2.8,
  ...
  TransiEnt.Consumer.Heat.Consumer consumer_7(
    ...
    Q_flow_nom(displayUnit="kW") = 350000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={116,54})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe17_18(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    N_cv=32) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={112,24})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe17_18R(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    MassFlowState=false,
  ...
  TransiEnt.Consumer.Heat.Consumer consumer_9(
    ...
    Q_flow_nom(displayUnit="kW") = 350000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={236,50})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe21_22(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    N_cv=32) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={232,20})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe21_22R(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    MassFlowState=false,
  ...
  TransiEnt.Consumer.Heat.Consumer consumer_8(
    ...
    Q_flow_nom(displayUnit="kW") = 350000) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={186,-144})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe19_20R(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    MassFlowState=false,
    N_cv=32) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={172,-114})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe19_20(
    d=0.065,
    m_flow_nom=2.8,
    l=156,
    N_cv=32) annotation (Placement(transformation(
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe8_10R(
    ...
    N_cv=20) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-136,96})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe7_8(
    d=0.08,
    m_flow_nom=5.58,
    l=500,
    MassFlowState=false,
    N_cv=100) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-154,28})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe7_8R(
    d=0.08,
    m_flow_nom=5.58,
    l=500,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe4_7R(
    d=0.1,
    m_flow_nom=8.36,
    l=100,
    MassFlowState=false,
    N_cv=32) annotation (Placement(transformation(extent={{-198,-48},{-178,-28}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe4_7(
    d=0.1,
    m_flow_nom=8.36,
    l=100,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe14_17R(
    d=0.1,
    m_flow_nom=8.73,
    l=100,
    MassFlowState=false,
    N_cv=20) annotation (Placement(transformation(extent={{84,-66},{64,-46}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe14_17(
    d=0.1,
    m_flow_nom=8.37,
    l=100,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Fittings.Join join1 annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-134,-52})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe7_12R(
    d=0.11,
    m_flow_nom=13.94,
    l=50,
    MassFlowState=false,
    N_cv=10) annotation (Placement(transformation(extent={{-78,-46},{-98,-26}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe7_12(
    d=0.11,
    m_flow_nom=13.94,
    l=50,
    MassFlowState=false,
  ...
  TransiEnt.Components.Heat.VolumesValvesFittings.Fittings.Split split2 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-262,-14})));
  TransiEnt.Basics.Interfaces.Thermal.FluidPortIn_simple inlet annotation (Placement(transformation(extent={{-68,148},{-48,168}})));
  TransiEnt.Basics.Interfaces.Thermal.FluidPortOut_simple outlet annotation (Placement(transformation(extent={{-10,148},{10,168}})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe12_13R(
    d=0.15,
    m_flow_nom=25.1,
    l=50,
    MassFlowState=false,
    N_cv=100) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-30,16})));
  TransiEnt.Components.Heat.VolumesValvesFittings.Pipes.DHN_Pipe_L4 pipe12_13(
    d=0.15,
    m_flow_nom=25.1,
    l=50,
    MassFlowState=false,
