...
//________________________________________________________________________________//
  ...
  Basics.Tables.GenericDataTable P_Z_UCTE_2012(path=
        "strom/PrognosefehlerSimuliertDurchInvertierung_ENTSO-E_60s_2012.txt",
      constantfactor=simCenter.P_n_ref_2)
    "Timeseries generated by inverting the derive grid dynamics model and putting the frequency measurement from 2012 at input"
    annotation (Placement(transformation(extent={{12,70},{34,90}})));
equation
