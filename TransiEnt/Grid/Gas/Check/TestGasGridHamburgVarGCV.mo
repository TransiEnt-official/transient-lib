...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Volume V_mixNG=1 "Volume of NG junctions" annotation (Evaluate=false);
...
<p>Tester for open-loop high pressure gas ring grid of Hamburg with variable gas composition calculation. The gas has constant composition but the all components use the equations for variable composition.</p>
<h4><span style=\"color: #008000\">2. Level of detail, physical effects considered, and physical insight</span></h4>
<p>The methodology is described in [1].</p>
<p><b><span style=\"color: #008000;\">3. Limits of validity </span></b></p><p>(none)</p>
