...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.HeatFlowRate Q_nom_condenser=max(PQboundaries[:, 1]) "define condenser nominal power separately without scaling PQ-characteristics";

  parameter Modelica.Units.SI.Efficiency eta_total_best=1 "Total efficiency in the best operating point";

  annotation (Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2; color: #008000;\">1. Purpose of model</span></b></p>
<p>record for generic PQ characteristics (empty)</p>
