...
//________________________________________________________________________________//
  ...
  Components.Boundaries.FluidFlow.FluidSink           fluidSink annotation (Placement(transformation(extent={{66,28},{46,48}})));
  Components.Boundaries.FluidFlow.FluidSource           fluidSource annotation (Placement(transformation(extent={{66,54},{46,74}})));
  Modelica.Blocks.Sources.RealExpression realExpression2(y=16e5) annotation (Placement(transformation(extent={{90,28},{70,48}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=1000) annotation (Placement(transformation(extent={{96,64},{76,84}})));
...
equation
  ...
  connect(realExpression2.y, fluidSink.p_in) annotation (Line(points={{69,38},{64,38}}, color={0,0,127}));
  connect(realExpression1.y, fluidSource.m_flow_in) annotation (Line(points={{75,74},{70,74},{70,67},{64,67}}, color={0,0,127}));
  connect(realExpression3.y, fluidSource.h_in) annotation (Line(points={{75,62},{64,62}}, color={0,0,127}));
  connect(fluidSink.port_a, Plant.outlet) annotation (Line(points={{46,38},{12,38},{12,-5.2},{4.46,-5.2}}, color={0,0,0}));
  connect(fluidSource.port_a, Plant.inlet) annotation (Line(points={{46,64},{38,64},{38,-10.8},{4.46,-10.8}}, color={0,0,0}));
