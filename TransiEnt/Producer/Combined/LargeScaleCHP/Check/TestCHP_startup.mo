...
//________________________________________________________________________________//
  ...
  Components.Boundaries.FluidFlow.FluidSink           fluidSink annotation (Placement(transformation(extent={{68,76},{48,96}})));
  Components.Boundaries.FluidFlow.FluidSource           fluidSource annotation (Placement(transformation(extent={{62,42},{42,62}})));
  Modelica.Blocks.Sources.RealExpression realExpression2(y=16e5) annotation (Placement(transformation(extent={{92,76},{72,96}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=1000) annotation (Placement(transformation(extent={{92,52},{72,72}})));
  ...
  Components.Boundaries.FluidFlow.FluidSink           fluidSink1
                                                                annotation (Placement(transformation(extent={{24,-40},{8,-24}})));
  Modelica.Blocks.Sources.RealExpression realExpression4(y=16e5) annotation (Placement(transformation(extent={{46,-41},{30,-23}})));
  Components.Boundaries.FluidFlow.FluidSource           fluidSource1
                                                                    annotation (Placement(transformation(extent={{40,-66},{20,-46}})));
  Modelica.Blocks.Sources.RealExpression realExpression5(y=1000) annotation (Placement(transformation(extent={{70,-56},{50,-36}})));
...
equation
  ...
  connect(Plant1.gasPortIn, boundary_pTxi.gasPort) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(realExpression2.y, fluidSink.p_in) annotation (Line(points={{71,86},{66,86}}, color={0,0,127}));
  connect(realExpression1.y, fluidSource.m_flow_in) annotation (Line(points={{71,62},{66,62},{66,55},{60,55}}, color={0,0,127}));
  connect(realExpression3.y, fluidSource.h_in) annotation (Line(points={{71,50},{60,50}}, color={0,0,127}));
  connect(fluidSource.port_a, Plant.inlet) annotation (Line(points={{42,52},{14,52},{14,30.1},{8.46,30.1}}, color={0,0,0}));
  connect(fluidSink.port_a, Plant.outlet) annotation (Line(points={{48,86},{34,86},{34,35.2333},{8.46,35.2333}}, color={0,0,0}));
  connect(realExpression4.y, fluidSink1.p_in) annotation (Line(points={{29.2,-32},{22.4,-32}}, color={0,0,127}));
  connect(Plant1.outlet, fluidSink1.port_a) annotation (Line(points={{0.46,-64.7667},{0.46,-66},{8,-66},{8,-32}}, color={0,0,0}));
  connect(realExpression5.y, fluidSource1.m_flow_in) annotation (Line(points={{49,-46},{44,-46},{44,-53},{38,-53}}, color={0,0,127}));
  connect(realExpression6.y, fluidSource1.h_in) annotation (Line(points={{49,-58},{38,-58}}, color={0,0,127}));
  connect(fluidSource1.port_a, Plant1.inlet) annotation (Line(points={{20,-56},{10,-56},{10,-69.9},{0.46,-69.9}}, color={0,0,0}));
