...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Sources.RealExpression realExpression2(y=16e5) annotation (Placement(transformation(extent={{84,4},{64,24}})));
function plotResult
...
equation
  ...
  connect(realExpression2.y,fluidSink. p_in) annotation (Line(points={{63,14},{50,14}},   color={0,0,127}));
  connect(fluidSink.port_a, Plant.outlet) annotation (Line(points={{32,14},{16,14},{16,-2.475},{11.5217,-2.475}}, color={0,0,0}));
