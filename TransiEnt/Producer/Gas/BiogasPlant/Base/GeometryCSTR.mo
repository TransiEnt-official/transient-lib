...
<p>Model containing all geometrical parameters of the CSTR to be used by other models. Volume of liquid and gaseous phase, Areas and height are calculated from the input parameters.</p>
