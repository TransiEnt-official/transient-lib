...
extends TransiEnt.Producer.Gas.BiogasPlant.Base.ADM1.Records.ADM1_parameters(
    ...
    f_xI_xc=0.2 "Particulate inerts from Composites",
    f_ch_xc=0.2 "Carbohydrates from Composites",
    f_pr_xc=0.2 "Proteins from Composites",
    f_li_xc=0.3 "Lipids from Composites",
    ...
    C_sI=30 "Carbon Content of soluble Inerts in molC/kgCOD",
    C_xc=27.86 "Carbon Content of Composites in molC/kgCOD",
    ...
    C_xI=30 "Carbon Content of Particulate Inerts in molC/kgCOD",
    N_aa=7 "Nitrogen Content of Amino Acids in molN/kgCOD",
    N_I=60/14 "Nitrogen Content of Inerts in molN/kgCOD",
    N_xc=37.6/14 "Nitrogen Content of Composites in molN/kgCOD",
    ...
    k_dis_meso=0.5/86400 "Disintegration Rate of Composites in 1/s",
    ...
    k_dec_ac_meso=0.02/86400 "Decay Rate of Acetate Degraders in 1/a",
    ...
    k_m_pro_meso=13/86400 "Maximum Uptake Rate of Propionate by Propionate degraders in kgCOD/kgCOD * 1/s",
    k_m_ac_meso=8/86400 "Maximum Uptake Rate of Acetate by Acetate degraders in kgCOD/kgCOD * 1/s",
    ...
    K_S_c4_meso=0.2 "Concentration of Valerate or Butyrate at which (uninhibited) uptake equals half of maximum uptake",
    K_S_pro_meso=0.1 "Concentration of Propionate at which (uninhibited) uptake equals half of maximum uptake",
    K_S_ac_meso=0.15 "Concentration of Acetate at which (uninhibited) uptake equals half of maximum uptake",
    ...
    K_I_H2_c4_meso=1e-5 "",
    K_I_H2_pro_meso=3.5e-6 "",
    K_I_NH3_meso=1.8 "",
    K_I_H2_c4_therm=3e-5,
    K_I_H2_pro_therm=1e-5,
    K_I_NH3_therm=11,
    Kw_ref=10^(-14)*1e6,
...
<p>List of all relevant physical and biochemical parameters for the digestion of <b>sludge</b> according to [1]</p>
<h4><span style=\"color: #008000\">References</span></h4>
<p>[1] Ros&eacute;n, C., &amp; Jeppsson, U. (2006). Aspects on ADM1 Implementation within the BSM2 Framework.</p>
