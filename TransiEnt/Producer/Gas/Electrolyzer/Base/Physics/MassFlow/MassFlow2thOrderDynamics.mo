...
model MassFlow2thOrderDynamics
  "PEMElectrolyzer mass flow as modeled by Espinosa, 2018 with 2th order dynamics"
...
equation
  ...
  der(x1) = x2;
  der(x2) = - 2 * zeta * omega_n  * x2 - omega_n^2 * x1 + omega_n^2 *molar_mass_H2*n_flow_H2;
  m_flow_H2 = x1;
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
    Documentation(info="<html>
<h4><span style=\"color: #008000\">Purpose of model</span></h4>
<p>This is a model to calculate mass flows in typical electrolyzers with second order dynamics.</p>
<h4><span style=\"color: #008000\">Level of detail, physical effects considered, and physical insight</span></h4>
<p>Dependent on stack current, Faraday&apos;s efficiency (1 by default), a damping ratio (0.7 by default) and the natural frequency of the electrolyseur (17 by default).</p>
<h4><span style=\"color: #008000\">Version History</span></h4>
<p>Model Created by Jan Westphal (j.westphal@tuhh.de) based on the MassFlow0thOrder model in Oct 2019</p>
</html>"));
end MassFlow2thOrderDynamics;
