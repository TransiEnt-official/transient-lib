...
//________________________________________________________________________________//
  ...
  extends TransiEnt.Producer.Electrical.Conventional.Components.NonlinearThreeStatePlant(
    eta_total=simCenter.generationPark.eta_el_n_BM,
    P_el_grad_max_SB=simCenter.generationPark.P_grad_max_star_BM,
    P_min_star=simCenter.generationPark.P_min_star_BM,
    P_grad_max_star=simCenter.generationPark.P_grad_max_star_BM,
    H =  simCenter.generationPark.H_gen_BM,
    P_el_n=
          simCenter.generationPark.P_el_n_BM,
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Tested in check model &quot;TransiEnt.Producer.Electrical.Others.Check.TestBiomass&quot;</span></p>
