...
//________________________________________________________________________________//
  ...
  IdealContinuousBiomassPlant IdealContinuousHydropower_Plant(P_el_n=80e6) annotation (Placement(transformation(extent={{-10,-39},{10,-19}})));
  ...
  Modelica.Blocks.Math.Gain P_set_plant_1(k=-IdealContinuousHydropower_Plant.P_el_n) annotation (Placement(transformation(extent={{-50,20},{-30,40}})));
equation

  connect(IdealContinuousHydropower_Plant.epp, Grid.epp) annotation (Line(
      points={{9,-22},{20,-22},{20,-23},{40,-23}},
      color={0,135,135},
      thickness=0.5));
  connect(sched.y, P_set_plant_1.u) annotation (Line(points={{-79,30},{-52,30}},          color={0,0,127}));
  connect(P_set_plant_1.y, IdealContinuousHydropower_Plant.P_el_set) annotation (Line(points={{-29,30},{-24,30},{-1.5,30},{-1.5,-19.1}}, color={0,0,127}));
public
    function plotResult

    constant String resultFileName = "TestIdealContinuousHydropowerPlant.mat";
    ...
    removePlots();
    createPlot(id=3, position={809, 0, 791, 695}, y={"P_set_plant_1.y", "IdealContinuousHydropower_Plant.epp.P"}, range={0.0, 12000.0, -60000000.0, 5000000.0}, grid=true, colors={{28,108,200}, {238,46,47}},filename=resultFile);
...
<p>Test environment for ideal continuous hydropower plants</p>
...
end TestIdealContinuousHydropowerPlant;
