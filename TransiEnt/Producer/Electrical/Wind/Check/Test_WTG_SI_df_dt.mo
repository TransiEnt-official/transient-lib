...
//________________________________________________________________________________//
  ...
  TransiEnt.Producer.Electrical.Wind.Windturbine_SI_dfdt WTG_1(
    ...
    pitchController(PitchController(y_start=9, initType=Modelica.Blocks.Types.Init.InitialState)),
    Ti_p=12,
    Td_p=3,
    k_p=0.8e-5,
    beta_start=0,
    ...
    use_inertia=true,
    P_el_n=3300000,
    integratePower=false) annotation (Placement(transformation(extent={{-2,6},{18,28}})));
