...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Tables.Ambient.GHI_Hamburg_3600s_2012_TMY
    gHI_Hamburg_3600s_0101_3112_IWECfile1
  ...
  PVPlant pVPlant(
    DiffuseModel="Skartveit and Olseth",
    ...
    integratePowerOut=false)
    annotation (Placement(transformation(extent={{-8,-10},{12,10}})));
equation
  connect(temperature_Hamburg_3600s_IWEC_from_SAM.y1, pVPlant.T_in) annotation (
     Line(points={{-43,50},{-26,50},{-26,8},{-10,8}}, color={0,0,127}));
  connect(gHI_Hamburg_3600s_0101_3112_IWECfile1.y1, pVPlant.GHI_in)
    annotation (Line(points={{-45,0},{-10,0}}, color={0,0,127}));
  connect(wind_Hamburg_3600s_01012012_31122012_Wind_Hamburg_175m.y1, pVPlant.WindSpeed_in)
    annotation (Line(points={{-43,-66},{-26,-66},{-26,-8},{-10,-8}}, color={0,0,
          127}));
...
public
  ...
  algorithm
    ...
    createPlot(
      ...
      y={"pVPlant.epp.P","gHI_Hamburg_3600s_0101_3112_IWECfile1.y1"},
