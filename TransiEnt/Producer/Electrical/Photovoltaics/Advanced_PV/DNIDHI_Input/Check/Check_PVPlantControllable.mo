...
model Check_PVPlantControllable
...
//________________________________________________________________________________//
  ...
  PVPlantControllable
    ...
    Soiling=0,
    useControlBus=true,
    use_ReactivePower=true,
    S_max(displayUnit="V.A") = 200,
    Q_max=200) annotation (Placement(transformation(extent={{-20,-12},{0,8}})));
  TransiEnt.Basics.Interfaces.General.ControlBus controlBus annotation (Placement(transformation(extent={{20,-80},{40,-60}})));
  Modelica.Blocks.Sources.BooleanStep booleanStep(startTime=3*365/4*86400, startValue=false) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={90,-50})));
  Modelica.Blocks.Sources.Step step(height=50, startTime=4*365/5*86400) annotation (Placement(transformation(extent={{80,-20},{100,0}})));
  Modelica.Blocks.Sources.Step Q_set(height=200, startTime=365/2*86400) annotation (Placement(transformation(extent={{80,-100},{100,-80}})));
equation
  connect(wind_Hamburg_3600s_01012012_31122012_Wind_Hamburg_175m.y1, pVPlantControllable.WindSpeed_in) annotation (Line(points={{-53,-76},{-34,-76},{-34,-10},{-22,-10}}, color={0,0,127}));
  connect(dHI_Hamburg_3600s_IWEC_from_SAM.y1, pVPlantControllable.DHI_in) annotation (Line(points={{-53,-44},{-36,-44},{-36,-4.6},{-22,-4.6}}, color={0,0,127}));
  connect(dNI_Hamburg_3600s_IWEC_from_SAM.y1, pVPlantControllable.DNI_in) annotation (Line(points={{-53,-14},{-38,-14},{-38,0.4},{-22,0.4}}, color={0,0,127}));
  connect(temperature_Hamburg_3600s_IWEC_from_SAM.y1, pVPlantControllable.T_in) annotation (Line(points={{-53,40},{-34,40},{-34,6},{-22,6}}, color={0,0,127}));
public
  function plotResult
...
equation
  ...
  connect(step.y, controlBus.P_limit) annotation (Line(points={{101,-10},{108,-10},{108,-32},{30,-32},{30,-70}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(pVPlantControllable.controlBus, controlBus) annotation (Line(
      points={{-10,-12},{-10,-70},{30,-70}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(Q_set.y, controlBus.Q_input) annotation (Line(points={{101,-90},{106,-90},{106,-108},{30,-108},{30,-70}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
