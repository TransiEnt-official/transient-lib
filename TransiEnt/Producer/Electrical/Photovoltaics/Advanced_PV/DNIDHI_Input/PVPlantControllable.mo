...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Voltage V_nominal=400 "Nominal Voltage";
  ...
  parameter
    ...
    PVModuleCharacteristics=
      TransiEnt.Producer.Electrical.Photovoltaics.Advanced_PV.Characteristics.PVModule_Characteristics_Sanyo_HIT_200_BA3()
    "Characteristics of PV Module" annotation (choicesAllMatching);

  //Skymodel
  parameter Modelica.Units.SI.Angle longitude_local=Modelica.Units.Conversions.from_deg(10)
  ...
  parameter Modelica.Units.SI.Angle longitude_standard=Modelica.Units.Conversions.from_deg(15)
  ...
  parameter Modelica.Units.SI.Angle latitude=Modelica.Units.Conversions.from_deg(53.55)
  ...
  parameter Modelica.Units.SI.Angle slope=Modelica.Units.Conversions.from_deg(30)
    "slope of the tilted surface, assumption"
    annotation (Dialog(tab="Irradiance", group="Extraterrestrial Irradiance", enable=not input_POA_irradiation));
  parameter Modelica.Units.SI.Angle surfaceAzimuthAngle=0 "surface azimuth angle"
    annotation (Dialog(tab="Irradiance", group="Extraterrestrial Irradiance", enable=not input_POA_irradiation));
  ...
  parameter Boolean use_ReactivePower=false "true, if reactive power can be set" annotation (Dialog(group="Inverter"));

  parameter Modelica.Units.SI.ApparentPower S_max(displayUnit="kvar") = P_inst "maximum apparent power" annotation (Dialog(enable=use_ReactivePower, group="Inverter"));

  parameter Modelica.Units.SI.ReactivePower Q_max=0.3*S_max "maximum reactive power" annotation (Dialog(enable=use_ReactivePower, group="Inverter"));
  // _____________________________________________
  //
  //                    Variables
  // _____________________________________________
  ...
  Modelica.Units.SI.ReactivePower Q_max_calc;
  // _____________________________________________
  //
  //                    Interfaces
  // _____________________________________________

  TransiEnt.Basics.Interfaces.General.TemperatureCelsiusIn T_in "ambient temperature in Celcius"
  ...
  TransiEnt.Basics.Interfaces.Electrical.ComplexPowerPort epp "power output"
...
public
  ...
  Models_CyEntEE.CellModels.CPP.Boundaries.PQBoundary pq1(
    ...
    v_n=V_nominal) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={70,0})));
  Modelica.Blocks.Sources.RealExpression Q_out_standard_2(y=0) if use_ReactivePower and not useControlBus annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={190,-90})));
  Modelica.Blocks.Sources.RealExpression P_out_limit(y=P_out) if (controlType == ControlType.Limit_P) annotation (Placement(transformation(extent={{-92,-70},{-72,-50}})));
  Modelica.Blocks.Math.Min min if (controlType == ControlType.Limit_P) annotation (Placement(transformation(extent={{-52,-70},{-32,-50}})));
  Modelica.Blocks.Sources.RealExpression P_out_standard(y=-P_out) if not (controlType == ControlType.Limit_P) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={120,-30})));
  Modelica.Blocks.Logical.Switch LimitSwitch if (controlType == ControlType.Limit_P) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-2,-60})));
  Modelica.Blocks.Math.Gain gain(k=-1) if (controlType == ControlType.Limit_P) annotation (Placement(transformation(extent={{26,-70},{46,-50}})));
  Modelica.Blocks.Nonlinear.Limiter maxQ_Limit(uMax=abs(Q_max)) if use_ReactivePower
                                                                    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={150,-90})));
  Modelica.Blocks.Nonlinear.VariableLimiter QLimiter if use_ReactivePower
                                                              annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={110,-90})));
  Modelica.Blocks.Sources.RealExpression Q_limit(y=Q_max_calc) if use_ReactivePower
                                                         annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={190,-110})));
  Modelica.Blocks.Sources.RealExpression Q_limit2(y=-Q_max_calc) if use_ReactivePower
                                                         annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={190,-70})));
  Modelica.Blocks.Sources.RealExpression Q_out_standard(y=0) if not use_ReactivePower annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={120,-50})));
  Modelica.Blocks.Sources.RealExpression Active_Power_Output(y=epp.P) if useControlBus annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-30,-130})));
  Modelica.Blocks.Sources.RealExpression Reactive_Power_Output(y=epp.Q) if useControlBus annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-30,-150})));
  Modelica.Blocks.Sources.RealExpression Maximum_Active_Power_Output(y=P_inst) if useControlBus annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={30,-130})));
equation
  ...
  connect(pq1.epp, epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(P_out_limit.y, min.u1) annotation (Line(points={{-71,-60},{-64,-60},{-64,-54},{-54,-54}}, color={0,0,127}));
  connect(min.u2, controlBus.P_limit) annotation (Line(points={{-54,-66},{-54,-74},{0,-74},{0,-100}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(min.y, LimitSwitch.u1) annotation (Line(points={{-31,-60},{-24,-60},{-24,-52},{-14,-52}},
                                                                                             color={0,0,127}));
  connect(LimitSwitch.u2, controlBus.SignalActive) annotation (Line(points={{-14,-60},{-14,-100},{0,-100}},               color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
  ...
  connect(maxQ_Limit.u, controlBus.Q_input) annotation (Line(points={{162,-90},{170,-90},{170,-112},{26,-112},{26,-100},{0,-100}}, color={0,0,127}), Text(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(Active_Power_Output.y, controlBus.P_out) annotation (Line(points={{-19,-130},{0,-130},{0,-100}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(Reactive_Power_Output.y, controlBus.Q_out) annotation (Line(points={{-19,-150},{0,-150},{0,-100}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(Maximum_Active_Power_Output.y, controlBus.P_max) annotation (Line(points={{19,-130},{2,-130},{2,-122},{0,-122},{0,-100}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  annotation (
    Diagram(          coordinateSystem(preserveAspectRatio=false, extent={{-100,
        ...
        Rectangle(
          extent={{-154,132},{42,-36}},
          lineColor={0,149,152},
          pattern=LinePattern.Dash,
          lineThickness=0.5),
        Text(
          extent={{-154,132},{-100,100}},
          textColor={0,149,152},
          textString="PV Power 
DC to AC Calculation"),
        Rectangle(
          extent={{88,-62},{218,-134}},
          lineColor={0,149,152},
          pattern=LinePattern.Dash,
          lineThickness=0.5),
        Text(
          extent={{92,-122},{216,-134}},
          textColor={0,149,152},
          textString="Conditional Reactive Power Calculation
"),     Rectangle(
          extent={{-138,-42},{58,-76}},
          lineColor={0,149,152},
          pattern=LinePattern.Dash,
          lineThickness=0.5),
        Text(
          extent={{-136,-42},{-100,-76}},
          textColor={0,149,152},
          textString="Conditional
Active Power
Limit Calculation"),
        Rectangle(
          extent={{-52,-114},{54,-172}},
          lineColor={0,149,152},
          pattern=LinePattern.Dash,
          lineThickness=0.5),
        Text(
          extent={{-38,-158},{42,-168}},
          textColor={0,149,152},
          textString="Outputs for Grid Simulations")}),
    Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2; color: #008000;\">1. Purpose of model</span></b></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">The purpose of this model is to calculate the power of a photovoltaic (PV) module or several modules with an controllable inverter. The active power generation can be limited, the reactive power can be adjusted based on the active power and apparent power.</span></p>
...
<p><b><span style=\"font-family: MS Shell Dlg 2;\">controlBus</span> </b>for P_limit, SignalActive and Q_input (conditional interface activated by parameter useControlBus)</p>
...
<p><b><span style=\"font-family: MS Shell Dlg 2;\">controlBus</span></b> for P_out, Q_out (conditional interface activated by parameter useControlBus)</p>
...
<p><b><span style=\"font-family: MS Shell Dlg 2; color: #008000;\">6.4. Active Power Output epp.P</span></b></p>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">P_out</span></b> is calculated by:</p>
<p><span style=\"font-family: Courier New;\">if P_dc*EfficiencyCurve_Inverter.y[1]*(100-LossesAC)/100 &lt; P_inverter then</span></p>
<p><span style=\"font-family: Courier New;\">P_out=P_dc*EfficiencyCurve_Inverter.y[1]*(100-LossesAC)/100;</span></p>
<p><span style=\"font-family: Courier New;\">else</span></p>
<p><span style=\"font-family: Courier New;\">P_out=P_inverter;</span></p>
<p><span style=\"font-family: Courier New;\">end if;</span></p>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">epp.P</span><span style=\"font-family: Courier New;\"> </span></b>is calculated by:</p>
<p><span style=\"font-family: Courier New;\">if controlBus.SignalActive then</span></p>
<p><span style=\"font-family: Courier New;\">epp.P = min(controlBus.P_limit, P_out);</span></p>
<p><span style=\"font-family: Courier New;\">else</span></p>
<p><span style=\"font-family: Courier New;\">epp.P = P_out;</span></p>
<p><span style=\"font-family: Courier New;\">end if;</span></p>
<p><b><span style=\"font-family: Courier New;\">EfficiencyCurve_Inverter.y[1]</span></b> is the efficiency of the simulated inverter depending on the inverter load. If P_dc exceeds the inverter power <b>P_inverter</b> the output is cut off to P_inverter as its maximum, where P_inverter is defined as the installed PV DC power divided by <b>DCtoACratio</b> which is the ratio between installed DC and AC power. <b>LossesAC</b> are losses on the AC side not included in inverter efficiency.</p>
<p><b><span style=\"font-family: MS Shell Dlg 2; color: #008000;\">6.4. Reactive Power Output epp.Q</span></b></p>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">epp.Q</span></b> has to be set externally over controlBus.Q_input and is limited by Q_max_calc (Variable) and Q_max (Parameter) over two conditional limiters.</p>
<p>Q_max_calc^2 = S_max^2 - P_out^2</p>
<p>if useControlBus and use_ReactivePower then</p>
<p>epp.Q = min(controlBus.Q_input, Q_max_calc, Q_max);</p>
<p>else</p>
<p>epp.Q = 0 VAr;</p>
<p>end if;</p>
...
<p><span style=\"font-family: Courier New;\">Adjusted by Tom Steffen, Techische Universit&auml;t Hamburg, Institut f&uuml;r Elektrische Energietechnik, 2025</span></p>
</html>"),
