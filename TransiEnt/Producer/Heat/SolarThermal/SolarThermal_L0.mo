...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.PressureDifference p_drop=1e5 "Nominal pressure drop";
  parameter Modelica.Units.SI.HeatFlowRate Q_flow_n=750e3 "Nominal heat flow rate (cost calculation)";
  ...
  SI.Temperature T_in "Inflowing temperature into the solar thermal collector";
  SI.Temperature T_out "Outflowing temperature out of the solar thermal collector";
  ...
  //                  Interfaces
  // _____________________________________________
  TransiEnt.Basics.Interfaces.Thermal.FluidPortIn_simple waterPortIn annotation (Placement(transformation(extent={{-110,-70},{-90,-50}}), iconTransformation(extent={{90,-10},{110,10}})));
  TransiEnt.Basics.Interfaces.Thermal.FluidPortOut_simple waterPortOut annotation (Placement(transformation(extent={{94,-70},{114,-50}}), iconTransformation(extent={{-110,-10},{-90,10}})));
...
equation
  ...
  T_in=noEvent(actualStream(waterPortIn.h_outflow))/cf;
  T_out=noEvent(actualStream(waterPortOut.h_outflow))/cf;
  // _____________________________________________
  //
  //               Connect Statements
  // _____________________________________________
  ...
  connect(prescribedHeatflow_L1.fluidPortIn, waterPortIn) annotation (Line(points={{-17.4,-60},{-100,-60}}, color={0,0,0}));
  connect(prescribedHeatflow_L1.fluidPortOut, waterPortOut) annotation (Line(points={{17.4,-60},{104,-60}}, color={0,0,0}));
