...
//________________________________________________________________________________//
 ...
 // _____________________________________________
  ...
  parameter Boolean MinTimes=true "If true, minimum operation and shutoff times are considered" annotation (Dialog(group="Configuration", enable=not Modulating),
                                                                                                                                          choices(checkBox=true));

  parameter Modelica.Units.SI.Power Q_flow_n=1500 "Nominal heating power of Heatpump" annotation (Dialog(group="Heatpump"));
 ...
 // _____________________________________________
  ...
  Basics.Interfaces.General.TemperatureIn T_source  annotation (Placement(transformation(
        extent={{-12,-12},{12,12}},
        rotation=270,
        origin={24,104}), iconTransformation(
        extent={{-13,-13},{13,13}},
        rotation=270,
        origin={39,93})));
...
<p>Partial model of controller for heat pumps</p>
