...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Pressure p_set=6.5e5 "Set pressure at worst hydraulc point";

  parameter TILMedia.VLEFluidTypes.BaseVLEFluid Medium = simCenter.fluid1 "Medium in the component";

  parameter Real k=0.5 "Gain for PI-Controller" annotation(Dialog(group="PI-Controller"));
  parameter Modelica.Units.SI.Time Tc=3 "Time constant for PI-Controller" annotation (Dialog(group="PI-Controller"));
