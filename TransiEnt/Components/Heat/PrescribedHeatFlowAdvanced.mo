...
<p>Heat flow boundary including calculation of exergy content and a non-constant discretization sheme for the heat flows. It is used in the components of the high temperature heat storage: </p>
<p>TransiEnt.Storage.Heat.PackedBedStorage_L4</p>
