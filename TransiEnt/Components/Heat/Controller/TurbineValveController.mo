...
//________________________________________________________________________________//
 ...
 Modelica.Blocks.Interfaces.RealOutput y_T_set "Turbine valve opening setpoint" annotation (Placement(transformation(extent={{98,24},{118,44}}, rotation=0)));
  ...
  Modelica.Blocks.Tables.CombiTable1Dv MSP_ValveAperture(table=[0.0,0.0; m_T_set_slp_start,y_T_slp; m_T_set_slp_end,y_T_slp; 1,1], final columns={2}) annotation (Placement(transformation(extent={{-6,-8},{14,12}})));

  Modelica.Blocks.Tables.CombiTable1Dv NSP_ValveAperture(table=[0.0,0.0; m_T_set_slp_start,1; 1,1], final columns={2}) annotation (Placement(transformation(extent={{-10,38},{10,58}})));
