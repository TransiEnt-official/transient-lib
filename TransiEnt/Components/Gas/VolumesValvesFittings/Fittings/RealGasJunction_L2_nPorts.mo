...
public
 ClaRa.Basics.Units.MassFraction xi[medium.nc - 1](stateSelect={if not constantComposition and Modelica.Math.Vectors.find(j, dependentCompositionEntries) == 0 then StateSelect.always else StateSelect.never for j in 1:medium.nc - 1});
