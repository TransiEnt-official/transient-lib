...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Sources.Sine sine(
    ...
    offset=-88.949/2/3/2,
    startTime=390,
    f=1/120) annotation (Placement(transformation(extent={{-102,-62},{-82,-42}})));
  ...
  TransiEnt.Components.Gas.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple_isoth pipe3(
    diameter_i=0.366,
    Delta_p_nom(displayUnit="bar") = 534880,
    length=30650,
    m_flow_nom=88.949/3,
  ...
  TransiEnt.Components.Boundaries.Gas.BoundaryRealGas_pTxi sink_p3(p_const=1450000) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={88,-112})));
  TransiEnt.Components.Gas.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple_isoth pipe4(
    constantComposition=true,
    diameter_i=0.366,
    Delta_p_nom(displayUnit="bar") = 534880,
    length=30650,
