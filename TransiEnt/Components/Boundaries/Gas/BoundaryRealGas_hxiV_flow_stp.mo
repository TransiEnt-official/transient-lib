...
public
  ...
  TransiEnt.Basics.Interfaces.General.VolumeFlowRateIn V_flow_n=V_flow_n_in if (variable_V_flow_n) "Variable volume flow rate under normal conditions"
...
equation
 ...
 annotation (defaultComponentName="boundary_hxiV_flow",Icon(graphics={
        Text(
          extent={{-78,32},{82,-28}},
          lineColor={27,36,42},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Boundary for real gases with volume flow at STP, specific enthalpy and mass fraction input. </span></p>
...
end BoundaryRealGas_hxiV_flow_stp;
