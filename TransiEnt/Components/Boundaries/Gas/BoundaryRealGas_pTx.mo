...
public
  ...
  TransiEnt.Basics.Interfaces.General.MoleFractionIn x[medium.nc-1]=x_in if (variable_x) "Variable molar composition"
...
equation
 ...
 annotation (defaultComponentName="boundary_pTx",Icon(graphics={
        Text(
          extent={{-78,32},{82,-28}},
          lineColor={27,36,42},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Boundary for real gases with pressure, temperature and mole fraction input. </span></p>
