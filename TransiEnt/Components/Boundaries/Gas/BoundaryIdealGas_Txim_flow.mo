...
public
  ...
  TransiEnt.Basics.Interfaces.General.MassFractionIn xi[gasModel.nc - 1]=xi_in if (variable_xi) "Variable mass composition" annotation (Placement(transformation(extent={{-120,-80},{-80,-40}}), iconTransformation(extent={{-140,-80},{-100,-40}})));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">IdealGasEnthPortOut</span></p>
