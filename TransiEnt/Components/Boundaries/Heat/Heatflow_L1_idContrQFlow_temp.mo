...
<p>This model is a heat flow boundary which calculates the heat flow rate to get a given outlet temperature. It can be chosen if the outlet set temperature is constant or given by an input.</p>
...
<p>The model calculates any heat flow rate that is necessary to reach the given temperature. So, there are no heat flow rate limits and no limitations in regard of flow direction (positive/negative).</p>
...
<p>TransiEnt.Components.Boundaries.Heat.Check.Test_Heatflow_L1_idContrQFlow</p>
<h4><span style=\"color: #008000\">Version History</span></h4>
<p>Model created by Carsten Bode (c.bode@tuhh.de), Nov 2018</p>
</html>"));
end Heatflow_L1_idContrQFlow_temp;
