...
equation
  connect(ElectricGrid.epp, Consumer.epp) annotation (Line(points={{-36,0},{-2.95,0},{28,0}},              color={0,127,0}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Text(
          extent={{18,76},{92,64}},
          lineColor={28,108,200},
          textString="Look at:
ElectricGrid.epp.P
ElectricGrid.epp.Q")}), Documentation(info="<html>
<h4><span style=\"color: #008000\">1. Purpose of model</span></h4>
<p>Test environment for electric boundaries with the interface L2 </p>
