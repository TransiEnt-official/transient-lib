...
function AllocationMethod_CreditsThermal "credits thermal to electrical generation"
...
algorithm
  ...
  m_flow_spec_th := m_flow_spec_th_ref * eta_th;
  m_flow_spec_el := m_flow_spec - m_flow_spec_th;
  alloc_m_flow_spec :={m_flow_spec_el, m_flow_spec_th};
  annotation (Documentation(info="<html>
<h4><span style=\"color: #008000\">1. Purpose of model</span></h4>
<p>This function allocates the specific massflowrate of carbon dioxide equivalents of a coupled thermal and eletrical process to the thermal and electrical side based on the thermal credits method.</p>
<p><img src=\"modelica://TransiEnt/Images/allocationCreditsThermal.png\"/></p>
...
<p><img src=\"modelica://TransiEnt/Images/equations/equation-AMFHbt53.png\" alt=\"m_flowSpecTh = m_flowSpecThRef * eta_th\"/></p>
<p><img src=\"modelica://TransiEnt/Images/equations/equation-EIxp8UZL.png\" alt=\"m_flowSpecEl = m_flowSpec - m_flowSpecTh\"/>.</p>
