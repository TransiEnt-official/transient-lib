...
model CavernBrownField "Cost model for brown field caverns"
...
//________________________________________________________________________________//
  ...
  extends PartialCostSpecs(
    ...
    C_inv_size=5e6 + 19.33*size1 "taken from figure 44 from Stiller.2010 (Potenziale der Wind-Wasserstoff-Technologie in der Freien und Hansestadt Hamburg und in Schleswig-Holstein)",
    factor_OM=0.02 "2%, Stolzenburg 2014",
    lifeTime=30 "Stolzenburg 2014");
  annotation (Documentation(info="<html>
<h4><span style=\"color: #008000\">1. Purpose of model</span></h4>
<p>cost model for brown field caverns</p>
