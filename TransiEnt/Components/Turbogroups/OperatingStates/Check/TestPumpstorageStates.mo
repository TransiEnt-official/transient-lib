...
equation
  ...
  connect(ps_prodInit.P_set_star_lim, ps_prodInit.P_actual_star) annotation (Line(
      points={{23.2,-23.8571},{28,-23.8571},{28,-46},{12,-46},{12,-36}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(ps_consInit.P_set_star_lim, ps_consInit.P_actual_star) annotation (Line(
      points={{15.2,48.1429},{20,48.1429},{20,28},{4,28},{4,36}},
      color={0,135,135},
      pattern=LinePattern.Dash));
