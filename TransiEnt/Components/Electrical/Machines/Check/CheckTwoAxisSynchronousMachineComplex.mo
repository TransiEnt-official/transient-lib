...
model CheckTwoAxisSynchronousMachineComplex "Test for TwoAxisSynchronousMachineComplex"
...
// _____________________________________________
  ...
  Modelica.Blocks.Continuous.FirstOrder actuator2(
    k=1,
    T=0.3,
    initType=Modelica.Blocks.Types.Init.InitialState) annotation (Placement(transformation(extent={{-70,106},{-90,126}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary2(tau_is(start=63662))
        ...
        rotation=0,
        origin={-155,63})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplex twoAxisSynchronousMachineComplex2(v_n=380e3) annotation (Placement(transformation(extent={{-110,52},{-90,72}})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplex       twoAxisSynchronousMachineComplex1(IsSlack=true)
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary3(tau_is(start=63662))
        ...
        rotation=0,
        origin={-159,-17})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplex twoAxisSynchronousMachineComplex3(v_n=380e3) annotation (Placement(transformation(extent={{-112,-28},{-92,-8}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary4(tau_is(start=63662))
        ...
        rotation=0,
        origin={-157,-99})));
  TransiEnt.Components.Electrical.Machines.TwoAxisSynchronousMachineComplex twoAxisSynchronousMachineComplex4(v_n=380e3, R_a=0) annotation (Placement(transformation(extent={{-106,-108},{-86,-88}})));
  ...
  TransiEnt.Components.Sensors.ElectricFrequencyComplex globalFrequency annotation (Placement(transformation(extent={{-158,126},{-138,146}})));
...
function plotResult
  ...
  constant String resultFileName = "CheckTwoAxisSynchronousMachineComplex.mat";
...
algorithm
  ...
  removePlots();
createPlot(id=1, position={809, 0, 791, 733}, y={"twoAxisSynchronousMachineComplex1.v_d", "twoAxisSynchronousMachineComplex1.v_q"}, grid=true, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
createPlot(id=1, position={809, 0, 791, 364}, y={"twoAxisSynchronousMachineComplex1.i_d", "twoAxisSynchronousMachineComplex1.i_q"}, grid=true, subPlot=2, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
createPlot(id=2, position={0, 0, 791, 733}, y={"twoAxisSynchronousMachineComplex1.epp.f"}, grid=true, colors={{28,108,200}}, filename=resultFile);
createPlot(id=2, position={0, 0, 791, 364}, y={"twoAxisSynchronousMachineComplex3.epp.P", "twoAxisSynchronousMachineComplex3.epp.Q"},  grid=true, subPlot=2, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
...
initial equation
  ...
  P_slack_start=twoAxisSynchronousMachineComplex1.P_mech;
...
// _____________________________________________
  ...
  connect(actuator2.y, turbine2.u) annotation (Line(points={{-91,116},{-102,116}}, color={0,0,127}));
  connect(actuator2.u, feedback.y) annotation (Line(points={{-68,116},{-62,116},{-62,148},{-115,148}}, color={0,0,127}));
  connect(twoAxisSynchronousMachineComplex1.mpp, constantInertia1.mpp_a) annotation (Line(points={{2,102},{2,102},{2,102},{22,102}},   color={95,95,95}));
  connect(constantInertia1.mpp_b, mechanicalBoundary1.mpp) annotation (Line(points={{42,102},{48,102},{48,103},{58,103}},                 color={95,95,95}));
  connect(twoAxisSynchronousMachineComplex2.mpp, constantInertia2.mpp_b) annotation (Line(points={{-110,62},{-116,62},{-116,62}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplex3.mpp, constantInertia3.mpp_b) annotation (Line(points={{-112,-18},{-120,-18},{-120,-16}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplex4.mpp, constantInertia4.mpp_b) annotation (Line(points={{-106,-98},{-116,-98},{-116,-98}},       color={95,95,95}));
  ...
  connect(twoAxisSynchronousMachineComplex1.epp, load.epp) annotation (Line(
      points={{-18.1,101.9},{-18,101.9},{-18,102},{-24,102},{-28,102},{-28,82},{-28,82},{-28,64},{-28,64},{-28,44},{-5.8,44}},
      color={28,108,200},
      thickness=0.5));
  connect(transformerComplex2.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine2.epp_p, twoAxisSynchronousMachineComplex2.epp) annotation (Line(
  ...
  connect(complexPower2.epp, transmissionLine2.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine3.epp_p, twoAxisSynchronousMachineComplex3.epp) annotation (Line(
  ...
  connect(transmissionLine3.epp_n,transformerComplex3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine4.epp_p, twoAxisSynchronousMachineComplex4.epp) annotation (Line(
  ...
  connect(transformerComplex4.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization1.y, twoAxisSynchronousMachineComplex1.E_input) annotation (Line(points={{-27.4,118},{-7.7,118},{-7.7,111.9}},   color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization1.epp1, load.epp) annotation (Line(
      points={{-48,118},{-56,118},{-56,98},{-28,98},{-28,64},{-28,64},{-28,44},{-5.8,44}},
      color={28,108,200},
      thickness=0.5));
  connect(twoAxisSynchronousMachineComplex2.E_input, voltageRegulatorExcitationStabilization2.y) annotation (Line(points={{-100.3,71.9},{-126,71.9},{-126,92},{-114.6,92}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization2.epp1, twoAxisSynchronousMachineComplex2.epp) annotation (Line(
      points={{-94,92},{-86,92},{-86,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.epp1,transmissionLine3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.y, twoAxisSynchronousMachineComplex3.E_input) annotation (Line(points={{-116.6,10},{-130,10},{-130,-8.1},{-102.3,-8.1}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.y, twoAxisSynchronousMachineComplex4.E_input) annotation (Line(points={{-108.6,-68},{-118,-68},{-118,-88.1},{-96.3,-88.1}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.epp1, twoAxisSynchronousMachineComplex4.epp) annotation (Line(
      points={{-88,-68},{-80,-68},{-80,-98.1},{-85.9,-98.1}},
      color={28,108,200},
      thickness=0.5));
  connect(globalFrequency.f, feedback.u2) annotation (Line(points={{-137.6,136},{-128,136},{-128,140},{-124,140}}, color={0,0,127}));
  connect(globalFrequency.epp, twoAxisSynchronousMachineComplex2.epp) annotation (Line(
      points={{-158,136},{-158,128},{-94,128},{-94,92},{-86,92},{-86,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(slackPowert0.y, add1.u2) annotation (Line(points={{-21,136},{4.5,136},{4.5,126},{30,126}}, color={0,0,127}));
...
<p>Test environment for TwoAxisSynchronousMachineComplex</p>
...
end CheckTwoAxisSynchronousMachineComplex;
