...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Sources.Cosine P_load(
    ...
    offset=0.4e6,
    startTime=0,
    f=1/20) annotation (Placement(transformation(extent={{40,40},{60,60}})));
  Modelica.Blocks.Sources.Constant omega_n(k=2*3.14*50) "rad/sec"
  ...
  Modelica.Mechanics.Rotational.Components.Inertia Inertia(
    J=H_gen.k*omega_n.k^2/P_n.k,
    w(fixed=true, start=omega_n.k),
  ...
  Modelica.Blocks.Sources.Constant P_n(k=1e6)   annotation (Placement(transformation(extent={{-68,38},{-48,58}})));
  ...
  TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DummyExcitationSystem dummyExcitationSystem annotation (Placement(transformation(extent={{66,0},{46,20}})));
equation
  connect(Load.epp, Generator.epp) annotation (Line(
      points={{74.2,-18},{74.2,-20.1},{60.1,-20.1}},
      color={0,135,135},
      thickness=0.5));
  connect(Inertia.flange_b, Generator.mpp) annotation (Line(points={{24,-20},{40,-20},{40,-20},{40,-20}},         color={0,0,0}));
...
equation
  ...
  connect(omega_n.y, feedback.u1) annotation (Line(points={{-67,4},{-62,4}}, color={0,0,127}));
  ...
  connect(dummyExcitationSystem.epp1, Generator.epp) annotation (Line(
      points={{66,10},{66,-20},{60.1,-20.1}},
      color={0,135,135},
      thickness=0.5));
  connect(dummyExcitationSystem.y, Generator.E_input) annotation (Line(points={{45.4,10},{36,10},{36,-10.1},{49.7,-10.1}}, color={0,0,127}));
...
<p>Test environment for ActivePowerGenerator</p>
