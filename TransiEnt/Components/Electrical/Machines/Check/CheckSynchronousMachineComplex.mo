...
model CheckSynchronousMachineComplex "Test for SynchronousMachineComplex"
...
// _____________________________________________
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary2(tau_is(start=63662))
        ...
        rotation=0,
        origin={-155,63})));
  TransiEnt.Components.Electrical.Machines.SynchronousMachineComplex synchronousMachineComplex2(v_n=380e3) annotation (Placement(transformation(extent={{-110,52},{-90,72}})));
  TransiEnt.Components.Electrical.Machines.SynchronousMachineComplex       synchronousMachineComplex1(IsSlack=true)
  ...
  TransiEnt.Components.Mechanical.ConstantInertia constantInertia1(P_n(displayUnit="MW") = 2000000000, J=1200e6*(simCenter.T_grid)/(100*Modelica.Constants.pi)^2)
                                                                                                                                                               annotation (Placement(transformation(extent={{16,86},{36,106}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary3(tau_is(start=63662))
        ...
        rotation=0,
        origin={-159,-17})));
  TransiEnt.Components.Electrical.Machines.SynchronousMachineComplex synchronousMachineComplex3(v_n=380e3) annotation (Placement(transformation(extent={{-112,-28},{-92,-8}})));
  ...
  TransiEnt.Components.Boundaries.Mechanical.Power mechanicalBoundary4(tau_is(start=63662))
        ...
        rotation=0,
        origin={-157,-99})));
  TransiEnt.Components.Electrical.Machines.SynchronousMachineComplex synchronousMachineComplex4(v_n=380e3) annotation (Placement(transformation(extent={{-106,-108},{-86,-88}})));
  ...
  TransiEnt.Components.Sensors.ElectricFrequencyComplex globalFrequency annotation (Placement(transformation(extent={{-156,116},{-136,136}})));
...
function plotResult
  ...
  constant String resultFileName = "CheckSynchronousMachineComplex.mat";
...
createPlot(id=1, position={0, 0, 791, 733}, y={"synchronousMachineComplex1.epp.f"}, grid=true, colors={{28,108,200}}, filename=resultFile);
createPlot(id=1, position={0, 0, 791, 364}, y={"synchronousMachineComplex3.epp.P", "synchronousMachineComplex3.epp.Q"},  grid=true, subPlot=2, colors={{28,108,200}, {238,46,47}}, filename=resultFile);
...
initial equation
  ...
  P_slack_start=synchronousMachineComplex1.P_mech;
...
// _____________________________________________
  ...
  connect(synchronousMachineComplex1.mpp, constantInertia1.mpp_a) annotation (Line(points={{6,96},{2,96},{2,96},{16,96}},       color={95,95,95}));
  connect(constantInertia1.mpp_b, mechanicalBoundary1.mpp) annotation (Line(points={{36,96},{38,96},{38,102},{48,102},{48,103},{58,103}}, color={95,95,95}));
  connect(synchronousMachineComplex2.mpp, constantInertia2.mpp_b) annotation (Line(points={{-110,62},{-116,62},{-116,62}},       color={95,95,95}));
  ...
  connect(synchronousMachineComplex3.mpp, constantInertia3.mpp_b) annotation (Line(points={{-112,-18},{-120,-18},{-120,-16}},       color={95,95,95}));
  ...
  connect(synchronousMachineComplex4.mpp, constantInertia4.mpp_b) annotation (Line(points={{-106,-98},{-116,-98},{-116,-98}},       color={95,95,95}));
  ...
  connect(synchronousMachineComplex1.epp, load.epp) annotation (Line(
      points={{-14.1,95.9},{-14,95.9},{-14,96},{-14,96},{-28,96},{-28,44},{-5.8,44}},
      color={28,108,200},
      thickness=0.5));
  connect(transformerComplex2.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine2.epp_p, synchronousMachineComplex2.epp) annotation (Line(
  ...
  connect(complexPower2.epp, transmissionLine2.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine3.epp_p, synchronousMachineComplex3.epp) annotation (Line(
  ...
  connect(transmissionLine3.epp_n,transformerComplex3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine4.epp_p, synchronousMachineComplex4.epp) annotation (Line(
  ...
  connect(transformerComplex4.epp_n, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization1.y, synchronousMachineComplex1.E_input) annotation (Line(points={{-27.4,118},{-3.7,118},{-3.7,105.9}},   color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization1.epp1, load.epp) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(synchronousMachineComplex2.E_input, voltageRegulatorExcitationStabilization2.y) annotation (Line(points={{-100.3,71.9},{-126,71.9},{-126,92},{-114.6,92}}, color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization2.epp1, synchronousMachineComplex2.epp) annotation (Line(
      points={{-94,92},{-92,92},{-92,90},{-90,90},{-90,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.epp1,transmissionLine3. epp_p) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(voltageRegulatorExcitationStabilization3.y, synchronousMachineComplex3.E_input) annotation (Line(points={{-116.6,10},{-130,10},{-130,-8.1},{-102.3,-8.1}},                   color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.y, synchronousMachineComplex4.E_input) annotation (Line(points={{-108.6,-68},{-118,-68},{-118,-88.1},{-96.3,-88.1}},
                                                                                                                                                           color={0,0,127}));
  connect(voltageRegulatorExcitationStabilization4.epp1, synchronousMachineComplex4.epp) annotation (Line(
      points={{-88,-68},{-80,-68},{-80,-98.1},{-85.9,-98.1}},
      color={28,108,200},
      thickness=0.5));
  connect(globalFrequency.f, feedback.u2) annotation (Line(points={{-135.6,126},{-124.8,126},{-124.8,140},{-124,140}}, color={0,0,127}));
  connect(globalFrequency.epp, synchronousMachineComplex2.epp) annotation (Line(
      points={{-156,126},{-156,136},{-90,136},{-90,64},{-88,64},{-88,61.9},{-89.9,61.9}},
      color={28,108,200},
      thickness=0.5));
  connect(slackPowert0.y, add1.u2) annotation (Line(points={{-21,136},{4,136},{4,126},{30,126}}, color={0,0,127}));
              ...
              Icon(coordinateSystem(preserveAspectRatio=false, extent={{-200,-120},{100,180}}), graphics={
                                   Ellipse(
          lineColor={0,125,125},
...
<p>Test environment for SynchronousMachineComplex</p>
...
end CheckSynchronousMachineComplex;
