...
function plotResult
  ...
  constant String resultFileName = "GridN5AreaVoltageCollapseOEL.mat";
...
// _____________________________________________
  ...
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_Northern_2(
    ...
    p=2,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 200000) annotation (Placement(transformation(extent={{-42,30},{-22,50}})));
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_Northern_1(
    ChooseVoltageLevel=3,
    p=2,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 200000) annotation (Placement(transformation(extent={{-72,30},{-52,50}})));
  TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary pQBoundary4(
    useInputConnectorP=false,
    useInputConnectorQ=false,
    v_n(displayUnit="kV") = 380000)
                                   annotation (Placement(transformation(extent={{-52,72},{-68,88}})));
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_CentralLower_1(
    ...
    MVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.MVCabletypes.L1,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 300000) annotation (Placement(transformation(extent={{102,28},{126,52}})));
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_CentralLower_2(
    ...
    MVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.MVCabletypes.L1,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 300000) annotation (Placement(transformation(extent={{138,28},{162,52}})));
  TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary pQBoundary3(
    useInputConnectorP=false,
    useInputConnectorQ=false,
    v_n(displayUnit="kV") = 380000)
                                   annotation (Placement(transformation(extent={{136,68},{122,82}})));
  TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary pQBoundary5(
    useInputConnectorP=false,
    useInputConnectorQ=false,
    v_n(displayUnit="kV") = 380000)
                                   annotation (Placement(transformation(extent={{166,72},{150,86}})));
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_Southern_2(
    ...
    MVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.MVCabletypes.L1,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 250000) annotation (Placement(transformation(extent={{212,28},{236,52}})));
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_Southern_1(
    ...
    MVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.MVCabletypes.L1,
    HVCableType=TransiEnt.Components.Electrical.Grid.Characteristics.HVCabletypes.L6,
    l(displayUnit="km") = 250000) annotation (Placement(transformation(extent={{180,28},{204,52}})));
  TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary pQBoundary2(
    useInputConnectorP=false,
    useInputConnectorQ=false,
    v_n(displayUnit="kV") = 380000)
                                   annotation (Placement(transformation(extent={{208,2},{192,16}})));
equation
...
// _____________________________________________
  ...
  connect(transmissionLine_Southern_2.epp_p,transmissionLine_Southern_1. epp_n) annotation (Line(
      points={{212,40},{204,40}},
      color={28,108,200},
      thickness=0.5));
  connect(pQBoundary2.epp,transmissionLine_Southern_1. epp_n) annotation (Line(
      points={{208,9},{208,40},{204,40}},
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine_Southern_2.epp_n, Transformer_L2.epp_p) annotation (Line(
      points={{236,40},{248,40}},
      color={28,108,200},
      thickness=0.5));
  connect(biomass_G2.epp, Transformer_L2.epp_p) annotation (Line(
      points={{222.9,80.7},{242,80.7},{242,40},{248,40}},
      color={28,108,200},
      thickness=0.5));
  connect(transmissionLine_Southern_1.epp_p, transmissionLine_CentralLower_2.epp_n) annotation (Line(
      points={{180,40},{162,40}},
      color={28,108,200},
      thickness=0.5));
  connect(pQBoundary5.epp, transmissionLine_CentralLower_2.epp_n) annotation (Line(
      points={{166,79},{168,79},{168,40},{162,40}},
      color={28,108,200},
      thickness=0.5));
  connect(Transformer_L_c.epp_p, transmissionLine_CentralLower_2.epp_n) annotation (Line(
      points={{162,12},{168,12},{168,40},{162,40}},
      color={28,108,200},
      thickness=0.5));
  annotation (
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Example model for voltage collapse and test of OEL</span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Model created by Jan-Peter Heckel (jan.heckel@tuhh.de) based on a model by Zahra Nadia Faili (zahra.faili@tuhh.de) in July 2019 </span></p>
...
end GridN5AreaVoltageCollapseOEL;
