...
//________________________________________________________________________________//
  ...
  Basics.Blocks.UserDefinedFunction userDefinedFunction(y=A*exp(B*(userDefinedFunction.u - v_n)/v_n)) annotation (Placement(transformation(extent={{-64,20},{-40,32}})));
equation
  ...
  connect(derivative.y, feedback1.u2) annotation (Line(points={{5,14},{26,14},{26,39.6},{46,39.6}}, color={0,0,127}));
  connect(userDefinedFunction.u, y) annotation (Line(points={{-66.4,26},{-84,26},{-84,0},{106,0}}, color={0,0,127}));
