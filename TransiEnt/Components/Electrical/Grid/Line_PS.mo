...
//________________________________________________________________________________//
  ...
  //                   Variables
  // _____________________________________________
  Modelica.Units.SI.ActivePower P_abs_loss=epp_1.P + epp_2.P;
  Modelica.Units.SI.Frequency f_grid=epp_1.f;
  Modelica.Units.SI.Frequency delta_f_grid(displayUnit="mHz") = (f_grid - simCenter.f_n);
protected
  Modelica.Units.SI.ActivePower epp_2_ps;
