...
<p><span style=\"font-family: MS Shell Dlg 2;\">[height_port, layer_height, nLayer] Calculates the layer for a given height.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">  1 is the highest layer, nLayer the lowest</span></p>
