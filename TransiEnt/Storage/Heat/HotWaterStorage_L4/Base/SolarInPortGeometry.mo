...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Length height_port(min=0) "Height of lowest part of the heating coil";
  parameter Modelica.Units.SI.Length height_segment "Height of one segment";
 parameter Integer nSeg(min=1) "Number of vertical tank segments";

  parameter Modelica.Units.SI.Length length_port "length of port";
