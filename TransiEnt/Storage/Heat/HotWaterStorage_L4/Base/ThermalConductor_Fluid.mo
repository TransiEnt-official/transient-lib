...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Length height_Seg=1 "Height of one fluid layer";
  parameter Modelica.Units.SI.ThermalConductivity k=0.6 "Specific heat conductivity of fluid";
