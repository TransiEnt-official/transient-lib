...
partial model HeatTransferBasePB2Wall "Partial heat transfer model for packed Bed 2 Wall heat transfer"
...
//________________________________________________________________________________//
  ...
  SI.CoefficientOfHeatTransfer alpha[iCom.N_cv] "Heat transfer coefficient";

  annotation (Documentation(info="<html>
<h4><span style=\"color: #008000\">1. Purpose of model</span></h4>
<p>base class fo heat transfer correlation  packed bed to wall</p>
