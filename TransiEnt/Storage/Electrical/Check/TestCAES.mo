...
//________________________________________________________________________________//
  ...
  CAES Storage(redeclare model CostModel=TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.PumpStorage, StorageModelParams=TransiEnt.Storage.Electrical.Specifications.CAES(
        E_max=1e14,
        P_max_unload=900e6,
        P_max_load=90e6,
        eta_unload=1,
...
function plotResult
  ...
  constant String resultFileName = "TestCAES.mat";
