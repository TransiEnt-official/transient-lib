...
//________________________________________________________________________________//
  ...
  GenericElectricStorage
    ...
    StorageModelParams(
      ...
      eta_unload=baseparams.eta_unload,
      eta_load=baseparams.eta_load,
      selfDischargeRate=1/36000))    annotation (Placement(transformation(extent={{-15,-23},{15,7}})));
...
equation
  ...
  annotation (Diagram(graphics={Text(
          ...
          textString="This is the same test model as TestGenericElectricStorage
but with P_set_pu.timeScale=7200
and GenericStorageHyst instead of GenericStorage.
TestGenericElectricStorage would freeze at
...
end TestGenericElectricStorageHyst;
