...
model CAES "Model of a compressed air energy storage"
...
//________________________________________________________________________________//
  ...
  extends Base.GenericElectricStorage(
    StorageModelParams=Specifications.CAES(),
    redeclare model StationaryLossModel = TransiEnt.Storage.Base.SelfDischargeRate,
    redeclare model CostModel = TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.PartialStorageCostSpecs,
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Model of a compressed air energy storage.</span></p>
...
<p>Tested in check model &quot;TransiEnt.Storage.Electrical.Check.TestCAES&quot;</p>
