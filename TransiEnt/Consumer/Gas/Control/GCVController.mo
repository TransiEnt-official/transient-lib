...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Interfaces.General.MassFlowRateIn m_flow_is "Current mass flow in kg/s" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,106})));
  TransiEnt.Basics.Interfaces.General.SpecificEnthalpyIn GCV_is_sink "Actual gross calorific value in sink in J/kg" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        ...
        rotation=270,
        origin={-40,106})));
  TransiEnt.Basics.Interfaces.General.SpecificEnthalpyIn GCV_is_source "Actual gross calorific value in source in J/kg" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
...
equation
  ...
  connect(switch1.u1, GCV_is_source) annotation (Line(points={{-24,56},{-24,90},{0,90},{0,106}}, color={0,0,127}));
  connect(switch1.u3, GCV_is_sink) annotation (Line(points={{-40,56},{-40,106}},                   color={0,0,127}));
...
<p>GCV_is_sink - actual gross calorific value in sink in J/kg</p>
<p>GCV_is_source - actual gross calorific value in source in J/kg</p>
...
<p>Model modified by Carsten Bode (c.bode@tuhh.de), Nov 2020: added GCV in different flow directions </p>
</html>"));
end GCVController;
