...
model SmartFridgeFreezer "Model with fixed relation for some parameters"
...
//________________________________________________________________________________//
  ...
  Modelica.Units.SI.Temperature T=temperatureSensor.T;
...
<p>Model of a smart controlled fridge and freezer with fixed relation for some parameters. Full documentation is not available yet. Please see comments in code or contact author per mail.</p>
...
<p>Tested in check model &quot;TransiEnt.Consumer.DemandSideManagement.FridgePoolControl.Check.TestSmartFridgeFreezer&quot;</p>
