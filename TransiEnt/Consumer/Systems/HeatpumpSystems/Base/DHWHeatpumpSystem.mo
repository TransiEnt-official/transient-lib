...
//________________________________________________________________________________//
  ...
  extends TransiEnt.Producer.Heat.Power2Heat.Heatpump.Base.PartialHeatPumpSystemModel(         final nStor=1, final E_stor={storageDHW.C*params.DTdb_heatpump});
  ...
  Modelica.Blocks.Sources.Constant T_stor_dhw_set(k=params.T_stor_dhw_set) annotation (Placement(transformation(extent={{-112,8},{-92,28}})));
...
equation
  ...
  connect(T_stor_dhw_is.T, heatPumpWithControl.T) annotation (Line(points={{-29,-22},{-46,-22},{-46,20},{-37.6,20}},                   color={0,0,127}));
  connect(T_stor_dhw_set.y, heatPumpWithControl.T_set) annotation (Line(points={{-91,18},{-84,18},{-84,16},{-78,16},{-78,8},{-38.3,8},{-38.3,8.7}},
                                                                                                                                                  color={0,0,127}));
