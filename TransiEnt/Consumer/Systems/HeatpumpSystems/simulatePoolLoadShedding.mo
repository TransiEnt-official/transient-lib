...
//________________________________________________________________________________//
  ...
  TransiEnt.Consumer.Systems.HeatpumpSystems.Base.HeatpumpSystemPool heatpumpSystemPool(N=20) annotation (Placement(transformation(extent={{-14,-16},{16,14}})));
  ...
  inner TransiEnt.SimCenter simCenter(redeclare TransiEnt.Components.Boundaries.Ambient.AmbientConditions ambientConditions(redeclare TransiEnt.Basics.Tables.Ambient.Temperature_Hamburg_3600s_TMY temperature),
...
<p>Model created by Pascal Dubucq (dubucq@tuhh.de) 2014</p>
    ...
    Diagram(graphics={Text(
          ...
          textString="Look at: heatpumpSystemPool.isLoadShedding,
 ElectricGrid.epp.P and heatpumpSystemPool.Storage.SOC")}));
