...
//________________________________________________________________________________//
  ...
  //                  Interfaces
  // _____________________________________________
  Modelica.Electrical.QuasiStatic.SinglePhase.Sources.VariableVoltageSource VariableVoltageSource annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=270,
        origin={38,-30})));
  Modelica.Electrical.QuasiStatic.SinglePhase.Basic.Ground ground annotation (Placement(transformation(extent={{28,-102},{48,-82}})));
  ...
  Modelica.Blocks.Sources.Constant phi(k=0) annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Modelica.Electrical.QuasiStatic.SinglePhase.Sensors.PowerSensor powerSensor annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={38,4})));
  ...
  Modelica.Electrical.QuasiStatic.SinglePhase.Interfaces.PositivePin voltageP annotation (Placement(transformation(rotation=0, extent={{90,-10},{110,10}})));
equation
  // _____________________________________________
  //
  ...
  connect(powerSensor.apparentPower, complexToReal.u) annotation (Line(points={{49,-4},{56,-4},{56,24},{-10,24}}, color={85,170,255}));
