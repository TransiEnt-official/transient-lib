...
//________________________________________________________________________________//
  ...
  replaceable parameter TransiEnt.Basics.Media.Gases.VLE_VDIWA_SG6_var real constrainedby TILMedia.VLEFluidTypes.BaseVLEFluid "Medium name of real gas model" annotation (Dialog(group="Fundamental Definitions"), choicesAllMatching);
  replaceable parameter TransiEnt.Basics.Media.Gases.Gas_VDIWA_SG6_var ideal constrainedby TILMedia.GasTypes.BaseGas "Medium name of ideal gas model" annotation (Dialog(group="Fundamental Definitions"), choicesAllMatching);
  ...
  TransiEnt.Basics.Interfaces.Gas.IdealGasTempPortOut gasPortOut(Medium=ideal) "Output for ideal gas" annotation (Placement(transformation(extent={{90,-10},{110,10}})));
