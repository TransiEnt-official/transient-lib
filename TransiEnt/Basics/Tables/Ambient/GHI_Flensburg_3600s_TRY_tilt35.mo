...
model GHI_Flensburg_3600s_TRY_tilt35
  "GHI Flensburg TRY, 1 h resolution, tilt = 35"
...
//________________________________________________________________________________//
  ...
  relativepath="ambient/Radiation_PVModule_TRY-Flensburg_Az=0_Tilt=35.txt",
...
<p>Global Horizontal Irradiation in Flensburg in a test reference year (TRY) with 60 minutes time resolution. Radiation on tilted surface, Tilt=35, Azimuth=0.</p>
...
<p>Created by Julian Urbansky, Fraunhofer UMSICHT, in August 2021</p>
</html>"));
end GHI_Flensburg_3600s_TRY_tilt35;
