...
model DNI_Cologne_3600s_TRY "DNI Cologne TRY, 1 h resolution, Source: DWD/calculation"
...
<p>Direct Normal Irradiation in Cologne in a test reference year (TRY) with 60 minutes time resolution.</p>
...
<p>Test reference data contains only data for direct and diffuse horizontal irradiation, which has been converted to direct normal irradiation</p>
