...
<p>Target values for T_supply and T_return as function of the T_amb for the local heating networks of EON Hanse Waerme</p>
...
<p>Source:</p>
<p>Technische Richtlinien (TR) zum Anschluss an Waermenetze, 2012, p. 9 (EonWaerme2012)</p>
