...
//________________________________________________________________________________//
  ...
  GenericCombiTable1Ds heatingCurve(relativepath="heat/HeatingCurve_FloorHeating.txt", datasource=DataPrivacy.isPublic, columns={2,3});
  extends Icons.Model;
