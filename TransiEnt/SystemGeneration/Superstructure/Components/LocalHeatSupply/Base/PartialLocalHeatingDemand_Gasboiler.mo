...
partial model PartialLocalHeatingDemand_Gasboiler
...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Interfaces.Gas.RealGasPortIn gasIn(Medium=simCenter.gasModel1) annotation (Placement(transformation(extent={{90,-10},{110,10}})));
...
<p>Base class for model of gas boiler to cover local heating demand.</p>
...
end PartialLocalHeatingDemand_Gasboiler;
