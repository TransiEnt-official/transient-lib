...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Interfaces.RealInput p_gas_region annotation (Placement(transformation(extent={{-114,-8},{-94,12}})));
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-100,-80},{100,120}})),
    Icon(coordinateSystem(extent={{-100,-80},{100,120}})),
    Documentation(info="<html>
<h4><span style=\"color: #008000\">1. Purpose of model</span></h4>
<p>Base class for Controller for mass flow of gas storage in superstructure. </p>
