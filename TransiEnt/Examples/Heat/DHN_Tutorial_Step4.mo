...
equation
  ...
  connect(gasBoiler.outlet, simplePump1.inlet) annotation (Line(points={{-68,-50},{-32,-50},{-32,-56},{-26.16,-56}}, color={0,0,0}));
  connect(gasBoiler.inlet, split.outlet2) annotation (Line(points={{-87.8,-50},{-96,-50},{-96,-78},{10,-78},{10,-44}}, color={0,0,0}));
