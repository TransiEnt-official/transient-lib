...
equation
  ...
  connect(topologyA_Ports.outlet, hotWaterStorage_constProp_L4_1.waterPortIn_grid[1]) annotation (Line(points={{137.2,-14},{124,-14},{124,-22},{84,-22}}, color={0,0,0}));
  connect(hotWaterStorage_constProp_L4_1.waterPortIn_prod[1], simplePump2.outlet) annotation (Line(points={{64,-14},{44,-14},{44,-4},{38.16,-4}}, color={0,0,0}));
