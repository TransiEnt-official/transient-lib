...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Sources.RealExpression realExpression4(y=12)                                                                                annotation (Placement(transformation(extent={{-50,2},{-36,17}})));
  ...
  Modelica.Blocks.Sources.RealExpression realExpression2(y=12)                                                                                annotation (Placement(transformation(extent={{-48,-46},{-34,-31}})));
  ...
  TransiEnt.Producer.Combined.LargeScaleCHP.ContinuousCHP continuousCHP(PQCharacteristics=TransiEnt.Producer.Combined.LargeScaleCHP.Base.Characteristics.PQ_Characteristics_GuDFortuna(), Q_flow_n_CHP=15e6) annotation (Placement(transformation(extent={{-66,-68},{-46,-44}})));
  Modelica.Blocks.Sources.RealExpression realExpression5(y=continuousCHP.inlet.m_flow*((4186*60) - inStream(continuousCHP.inlet.h_outflow)))  annotation (Placement(transformation(extent={{-86,-48},{-66,-28}})));
  Modelica.Blocks.Sources.RealExpression realExpression8(y=0)                                                                                 annotation (Placement(transformation(extent={{-114,-52},{-94,-32}})));
  TransiEnt.Components.Boundaries.Electrical.ActivePower.Frequency ElectricGrid annotation (Placement(transformation(extent={{-22,-36},{-2,-16}})));
equation
  ...
  connect(realExpression2.y, simplePump1.m_flow) annotation (Line(points={{-33.3,-38.5},{-25.52,-38.5},{-25.52,-51.2}}, color={0,0,127}));
  connect(continuousCHP.outlet, simplePump1.inlet) annotation (Line(points={{-45.8,-58.6},{-45.8,-56},{-26.16,-56}}, color={0,0,0}));
  connect(continuousCHP.inlet, split.outlet2) annotation (Line(points={{-45.8,-61.4},{-32,-61.4},{-32,-88},{10,-88},{10,-44}}, color={0,0,0}));
  connect(realExpression5.y, continuousCHP.Q_flow_set) annotation (Line(points={{-65,-38},{-52.3,-38},{-52.3,-46.8}}, color={0,0,127}));
  connect(realExpression8.y, continuousCHP.P_set) annotation (Line(points={{-93,-42},{-62.1,-42},{-62.1,-46.8}}, color={0,0,127}));
  connect(continuousCHP.epp, ElectricGrid.epp) annotation (Line(
      points={{-46.5,-52.4},{-40,-52.4},{-40,-26},{-22,-26}},
      color={0,135,135},
      thickness=0.5));
