...
//________________________________________________________________________________//
  ...
  parameter SI.Pressure Delta_p_nom_pipe2=1e5 "|Pipes|Pressure loss in pipe 2";
  parameter SI.Pressure Delta_p_nom_pipe3=1e5 "|Pipes|Pressure loss in pipe 3";
  parameter SI.Pressure Delta_p_nom_pipe4=1e5 "|Pipes|Pressure loss in pipe 4";
