...
//________________________________________________________________________________//
  ...
  TransiEnt.Components.Gas.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple pipe3(
    ...
    Delta_p_nom=200000) annotation (Placement(transformation(
        extent={{14,-5},{-14,5}},
        rotation=90,
        origin={86,59})));
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T=600, y_start=heatFlow.T_start) annotation (Placement(transformation(extent={{-94,-87},{-84,-76}})));
  ...
  TransiEnt.Components.Boundaries.Electrical.ActivePower.Frequency ElectricGrid annotation (Placement(transformation(extent={{-78,-26},{-98,-6}})));
...
equation
  ...
  connect(junction3.gasPort3, sink1.gasPort) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(sink.m_flow, m_flow_gas.y) annotation (Line(points={{-38,104},{-42,104},{-42,105},{-47.3,105}}, color={0,0,127}));
  ...
  connect(source.gasPort, maxH2MassFlow.gasPortIn) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(maxH2MassFlow.m_flow_H2_max, feedInStation.m_flow_feedIn) annotation (Line(points={{-84,27},{-84,27},{-84,54},{-84,57.2},{-74,57.2}}, color={0,0,127}));
