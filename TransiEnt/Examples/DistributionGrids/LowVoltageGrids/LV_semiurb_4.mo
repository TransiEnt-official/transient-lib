...
model LV_semiurb_4 "Contains choices of scenarios T / I / A and Normale Bedingungen / High Simultaneity / Kalte Dunkelflaute"
  ...
  // ------------------------------------------------------------------------------------------
equation
  connect(lV_semiurb_4_T.epp, epp) annotation (Line(
      points={{-60,10.8},{-60,94},{0,94},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(lV_semiurb_4_I.epp, epp) annotation (Line(
      points={{0,10.8},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(lV_semiurb_4_A.epp, epp) annotation (Line(
      points={{60,10.8},{60,94},{0,94},{0,108}},
      color={28,108,200},
      thickness=0.5));
