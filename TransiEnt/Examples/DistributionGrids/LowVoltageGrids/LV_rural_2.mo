...
model LV_rural_2 "Contains choices of scenarios T / I / A and Normale Bedingungen / High Simultaneity / Kalte Dunkelflaute"
  ...
  TransiEnt.Examples.DistributionGrids.LowVoltageGrids.BaseScenarios.LV_rural_2_Today lV_rural_2_T(
  ...
  TransiEnt.Examples.DistributionGrids.LowVoltageGrids.BaseScenarios.LV_rural_2_Intermediate lV_rural_2_I(
    photovoltaicControlType=photovoltaicControlType,
    batteryControlType=batteryControlType,
    heatingControlType=heatingControlType,
    bevControlType=bevControlType,
  ...
  TransiEnt.Examples.DistributionGrids.LowVoltageGrids.BaseScenarios.LV_rural_2_Future lV_rural_2_A(
    photovoltaicControlType=photovoltaicControlType,
    batteryControlType=batteryControlType,
    heatingControlType=heatingControlType,
    bevControlType=bevControlType,
  ...
  // ------------------------------------------------------------------------------------------
equation
  connect(lV_rural_2_T.epp, epp) annotation (Line(
      points={{-60,10.8},{-60,94},{0,94},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(lV_rural_2_I.epp, epp) annotation (Line(
      points={{0,10.8},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(lV_rural_2_A.epp, epp) annotation (Line(
      points={{60,10.8},{60,94},{0,94},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(controlBus, lV_rural_2_T.controlBus) annotation ();
  connect(controlBus, lV_rural_2_I.controlBus) annotation ();
  connect(controlBus, lV_rural_2_A.controlBus) annotation ();
  annotation (
