...
model Check_LV_urban_6
  ...
  // ------------------------------------------------------------------------------------------
equation
  connect(lV_urban_6_1.epp, electricGrid_1.epp) annotation (Line(
      points={{0,10.8},{0,39.4},{32.07,39.4}},
      color={28,108,200},
      thickness=0.5));
  connect(lV_urban_6_1.controlBus, controlBus) annotation();
