...
//________________________________________________________________________________//  extends TransiEnt.Basics.Icons.Checkmodel;
  ...
  // ------------------------------------------------------------------------------------------
equation
  connect(lV_rural_2_1.controlBus, controlBus) annotation();
  connect(lV_rural_2_1.epp, electricGrid_1.epp) annotation (Line(
      points={{2,10.8},{2,39.4},{32.07,39.4}},
      color={28,108,200},
      thickness=0.5));
  annotation (
