...
model LV_semiurb_5_I "This model was automatically generated"
  ...
  Models_CyEntEE.CellModels.CPP.DecouplingGrids decouplingGrids annotation (Placement(transformation(extent={{-32,380},{-12,400}})));
