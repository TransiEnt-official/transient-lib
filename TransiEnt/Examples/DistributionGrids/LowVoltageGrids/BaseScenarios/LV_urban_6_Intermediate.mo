...
model LV_urban_6_Intermediate "Urban low voltage distribution grid scenario with intermediate technology penetration scenario."
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_1(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-9.43,127.9},{-4.43,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_2(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-9.43,-26.1},{-4.43,-21.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_3(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{71.07,89.4},{76.07,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_4(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{165.57,19.4},{170.57,24.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_5(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{155.07,64.9},{160.07,69.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_6(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{155.07,89.4},{160.07,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_7(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{127.07,-96.1},{132.07,-91.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_8(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-75.93,47.4},{-70.93,52.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_9(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{123.57,-194.1},{128.57,-189.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_10(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{127.07,-120.6},{132.07,-115.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_11(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,47.4},{-0.93,52.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_12(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-58.43,127.9},{-53.43,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_13(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{123.57,-47.1},{128.57,-42.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_14(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-96.93,47.4},{-91.93,52.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_15(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-50.6},{-0.93,-45.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_16(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{8.07,68.4},{13.07,73.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_17(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{148.07,-1.6},{153.07,3.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_18(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-124.1},{-0.93,-119.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_19(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-148.6},{-0.93,-143.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_20(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{123.57,-145.1},{128.57,-140.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_21(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{71.07,68.4},{76.07,73.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_22(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{218.07,-1.6},{223.07,3.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_23(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{127.07,-71.6},{132.07,-66.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_24(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-82.93,89.4},{-77.93,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_25(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-12.93,-1.6},{-7.93,3.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_26(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{15.07,47.4},{20.07,52.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_27(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-12.93,22.9},{-7.93,27.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_28(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{197.07,19.4},{202.07,24.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_29(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{74.57,22.9},{79.57,27.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_30(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{130.57,-22.6},{135.57,-17.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_31(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{120.07,-169.6},{125.07,-164.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_32(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{71.07,47.4},{76.07,52.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_33(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{15.07,89.4},{20.07,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_34(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{165.57,40.4},{170.57,45.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_35(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-169.6},{-0.93,-164.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_36(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-75.1},{-0.93,-70.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_37(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-86.43,68.4},{-81.43,73.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_38(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{158.57,-22.6},{163.57,-17.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_39(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-5.93,-99.6},{-0.93,-94.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_40(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{123.57,-218.6},{128.57,-213.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_41(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-61.93,-1.6},{-56.93,3.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_42(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-61.93,22.9},{-56.93,27.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_43(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-107.43,22.9},{-102.43,27.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_44(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-159.93,89.4},{-154.93,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_45(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-156.43,36.9},{-151.43,41.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_46(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-152.93,12.4},{-147.93,17.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_47(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-159.93,64.9},{-154.93,69.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_48(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-156.43,-12.1},{-151.43,-7.1}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_49(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-159.93,-36.6},{-154.93,-31.6}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_50(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-96.93,127.9},{-91.93,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_51(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-117.93,127.9},{-112.93,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_52(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-138.93,127.9},{-133.93,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_53(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-243.93,89.4},{-238.93,94.4}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_54(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-243.93,64.9},{-238.93,69.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_55(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{-243.93,36.9},{-238.93,41.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_56(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{60.57,127.9},{65.57,132.9}})));
  ...
  TransiEnt.Components.Electrical.Grid.Line_new line_57(
    ...
    i_n=364,
    parallel=1)
      annotation (Placement(transformation(extent={{18.57,127.9},{23.57,132.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_2(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{35.07,99.9},{50.07,114.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_9(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-41.93,36.9},{-26.93,51.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_10(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{238.07,-12.1},{253.07,2.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_14(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{49.07,36.9},{64.07,51.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_16(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{140.07,-180.1},{155.07,-165.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_25(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{14.07,-159.1},{29.07,-144.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_26(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{98.07,8.9},{113.07,23.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_27(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{91.07,99.9},{106.07,114.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_31(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{91.07,57.9},{106.07,72.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_32(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{140.07,-159.1},{155.07,-144.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_35(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{91.07,36.9},{106.07,51.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_38(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-62.93,78.9},{-47.93,93.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_43(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{-139.93,78.9},{-124.93,93.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_48(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{-139.93,-47.1},{-124.93,-32.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_50(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{-223.93,99.9},{-208.93,114.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_54(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-223.93,50.9},{-208.93,65.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_55(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{-203.93,50.9},{-188.93,65.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_56(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-223.93,22.9},{-208.93,37.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_57(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{-203.93,22.9},{-188.93,37.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_58(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-119.93,99.9},{-104.93,114.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_62(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{-92.93,22.9},{-77.93,37.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_64(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{-112.93,1.9},{-97.93,16.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_67(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-42.93,99.9},{-27.93,114.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_68(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{-42.93,78.9},{-27.93,93.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_75(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{69.07,36.9},{84.07,51.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_76(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R110())}) annotation (Placement(transformation(extent={{89.07,36.9},{104.07,51.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_79(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{34.07,-40.1},{49.07,-25.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_84(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{34.07,-110.1},{49.07,-95.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_89(
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{118.07,8.9},{133.07,23.9}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_105(
    ...
    useEHP=false,
    V_BST = 0.5,
    tappingProfileName="TappingCycle_I_105",
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_106(
    ...
    useEHP=false,
    V_BST = 0.6,
    tappingProfileName="TappingCycle_I_106",
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_107(
    ...
    useEHP=true,
    V_BST = 0.5,
    tappingProfileName="TappingCycle_I_107",
    Q_HP_nom=7810.77,
    A_living=149.66,
    A_wall=92.4035,
    A_window=29.9319,
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Volkswagen_ID3())}) annotation (Placement(transformation(extent={{167.07,-131.1},{182.07,-116.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_108(
    ...
    useEHP=false,
    V_BST = 0.5,
    tappingProfileName="TappingCycle_I_108",
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_109(
    ...
    useEHP=true,
    V_BST = 0.6,
    tappingProfileName="TappingCycle_I_109",
    Q_HP_nom=8835.06,
    A_living=178.713,
    A_wall=97.941,
    A_window=35.7426,
    ...
    bev_data={TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=11000.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Renault_Zoe_R90())}) annotation (Placement(transformation(extent={{207.07,-131.1},{222.07,-116.1}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_110(
    ...
    useEHP=false,
    V_BST = 0.6,
    tappingProfileName="TappingCycle_I_110",
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_111(
    ...
    useEHP=false,
    V_BST = 0.6,
    tappingProfileName="TappingCycle_I_111",
  ...
  TransiEnt.Components.Electrical.PowerTransformation.SimpleTransformerComplex simpleTransformerComplex(
    ...
    U_S=400,
    epp_p(v(start=10000)),
    epp_n(v(start=400))) annotation (Placement(transformation(extent={{-124,182},{-104,202}})));
  ...
  //   Equation part
  // ------------------------------------------------------------------------------------------
  TransiEnt.Components.Sensors.SmartMeter GridMeter annotation (Placement(transformation(extent={{-40,182},{-20,202}})));
equation
  // ---- Connect Interfaces ------------------------------------------------------------------
  ...
  connect(simpleTransformerComplex.epp_p, epp) annotation (Line(
      points={{-124,192},{-130,192},{-130,116},{-18,116},{-18,108},{0,108}},
      color={28,108,200},
      thickness=0.5));
  connect(GridMeter.epp_a, simpleTransformerComplex.epp_n) annotation (Line(
      points={{-39.2,192},{-104,192}},
      color={28,108,200},
      thickness=0.5));
  connect(GridMeter.epp_b, node_1.epp) annotation (Line(
      points={{-20.8,192},{-20.8,164},{-20,164},{-20,144},{-31.43,144},{-31.43,155.9}},
      color={28,108,200},
      thickness=0.5));
...
Number of BEV: 48")}),
    Icon(graphics={
        ...
        Text(
          ...
          lineColor={0,134,134},
          textString="%LV_urban_6_I")}));
end LV_urban_6_Intermediate;
