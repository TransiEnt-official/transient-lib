...
model LV_semiurb_4_A
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_12(
    ...
    bev_data={Models_CyEntEE.CellModels.Data.Records.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf()),Models_CyEntEE.CellModels.Data.Records.BEV_Data(
        useBEV=true,
        id=19,
        Bat_Capacity=196920000.0,
        Bat_SOCStart=1.0,
  ...
  Models_CyEntEE.CellModels.CPP.DecouplingGrids decouplingGrids annotation (Placement(transformation(extent={{-62,260},{-42,280}})));
