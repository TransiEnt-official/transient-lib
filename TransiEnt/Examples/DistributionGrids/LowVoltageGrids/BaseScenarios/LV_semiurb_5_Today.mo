...
model LV_semiurb_5_Today "Large semiurban low voltage distribution grid scenario with 2024 technology penetration scenario."
...
equation
  ...
  connect(GridMeter.epp_a, simpleTransformerComplex.epp_n) annotation (Line(
      points={{-9.2,398},{-60,398}},
      color={28,108,200},
      thickness=0.5));
  connect(GridMeter.epp_b, node_99.epp) annotation (Line(
      points={{9.2,398},{-1.09,398},{-1.09,359.96}},
      color={28,108,200},
      thickness=0.5));
