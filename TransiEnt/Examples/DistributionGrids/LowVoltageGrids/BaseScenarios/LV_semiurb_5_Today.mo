...
model LV_semiurb_5_T
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_8(
    ...
    usePV=true,
    PV_peakPower=9249.633,
    useBattery=true,
    useEHP=false,
    V_BST = 0.6,
    tappingProfileName="TappingCycle_T_8",
    num_BEVs=0) annotation (Placement(transformation(extent={{198.41,107.96},{213.41,122.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_14(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{198.41,86.96},{213.41,101.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_16(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{72.41,142.96},{87.41,157.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_23(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{247.41,296.96},{262.41,311.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_31(
    ...
    bev_data={Models_CyEntEE.CellModels.Data.Records.BEV_Data(
        ...
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{-67.59,128.96},{-52.59,143.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_35(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{128.41,-214.04},{143.41,-199.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_37(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-67.59,233.96},{-52.59,248.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_46(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{93.41,-445.04},{108.41,-430.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_47(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{44.41,-88.04},{59.41,-73.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_52(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-130.59,-46.04},{-115.59,-31.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_53(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-172.59,-207.04},{-157.59,-192.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_56(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-172.59,-172.04},{-157.59,-157.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_64(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-130.59,-18.04},{-115.59,-3.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_69(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{86.41,-312.04},{101.41,-297.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_71(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{198.41,-207.04},{213.41,-192.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_76(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{93.41,-368.04},{108.41,-353.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_77(
    ...
    bev_data={Models_CyEntEE.CellModels.Data.Records.BEV_Data(
        ...
        Bat_SOCStart=1.0,
        Bat_PowerLimit=7200.0,
        Bev_type=TransiEnt.Consumer.Electrical.ElectricVehicle.Characteristics.Nissan_Leaf())}) annotation (Placement(transformation(extent={{-130.59,37.96},{-115.59,52.96}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_79(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{93.41,-249.04},{108.41,-234.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_83(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{44.41,-277.04},{59.41,-262.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_85(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{198.41,-88.04},{213.41,-73.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_88(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{93.41,-396.04},{108.41,-381.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_89(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{198.41,-109.04},{213.41,-94.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_96(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{205.41,-158.04},{220.41,-143.04}})));
  ...
  TransiEnt.Components.Electrical.Prosumer.Prosumer household_97(
    ...
    num_BEVs=0) annotation (Placement(transformation(extent={{-130.59,-74.04},{-115.59,-59.04}})));
  ...
  TransiEnt.Components.Electrical.PowerTransformation.SimpleTransformerComplex simpleTransformerComplex(
    ...
    U_S=400,
    epp_p(v(start=10000)),
    epp_n(v(start=400))) annotation (Placement(transformation(extent={{-80,388},{-60,408}})));
  Models_CyEntEE.CellModels.CPP.DecouplingGrids decouplingGrids annotation (Placement(transformation(extent={{-44,388},{-24,408}})));
  ...
  //   Equation part
  // ------------------------------------------------------------------------------------------
  TransiEnt.Components.Sensors.SmartMeter GridMeter annotation (Placement(transformation(extent={{-10,388},{10,408}})));
equation
  // ---- Connect Interfaces ------------------------------------------------------------------
