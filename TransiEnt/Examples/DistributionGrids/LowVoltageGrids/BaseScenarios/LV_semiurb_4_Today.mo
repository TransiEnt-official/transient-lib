...
model LV_semiurb_4_T "This model was automatically generated"
  ...
  Models_CyEntEE.CellModels.CPP.DecouplingGrids decouplingGrids annotation (Placement(transformation(extent={{-52,252},{-32,272}})));
